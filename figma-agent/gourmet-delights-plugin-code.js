const sections = [
  "Header with restaurant logo and navigation links",
  "Hero section with a warm welcome and call to action",
  "Feedback form including email input, ratings, and comments area",
...
async function main() {
  ...
  frame.name = "Gourmet Delights" + ' - Restaurant Landing Page';
  ...
  title.fontSize = 72;
  title.characters = "Gourmet Delights";
  ...
  subtitle.characters = "Inviting and modern";
