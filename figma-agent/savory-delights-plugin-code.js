const sections = [
  "Hero Banner with Reservation CTA",
  "Menu Highlights",
  "Ambience & Decor",
  "Chef's Story",
...
async function main() {
  ...
  frame.name = "Savory Delights" + ' - Restaurant Landing Page';
  ...
  title.fontSize = 72;
  title.characters = "Savory Delights";
  ...
  subtitle.characters = "inviting, elegant, warm";
