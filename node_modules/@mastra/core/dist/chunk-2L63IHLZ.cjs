...
var PromptBlocksStorage = class extends chunkFJFMJDFF_cjs.VersionedStorageDomain {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      blocks = blocks.filter((block) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkHEE7C2GC_cjs.deepEqual(block.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-2L63IHLZ.cjs.map
//# sourceMappingURL=chunk-2L63IHLZ.cjs.map