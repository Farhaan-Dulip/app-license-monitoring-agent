...
var scoringEntityTypeSchema = v4.z.enum([
  ...
  "TRAJECTORY",
  "STEP",
  ...Object.values(chunkAHAX7NUG_cjs.SpanType)
]);
...
var scoringHookInputSchema = v4.z.object({
  ...
  projectId: v4.z.string().optional()
  // Note: observabilityContext is not serializable, so we don't include it in the schema
});
...
var scoreRowDataSchema = v4.z.object({
  ...
  organizationId: v4.z.string().nullish(),
  projectId: v4.z.string().nullish(),
  ...
  datasetId: v4.z.string().nullish(),
  datasetItemId: v4.z.string().nullish(),
  ...
  // Timestamps
  ...chunkAHAX7NUG_cjs.dbTimestamps
});
...
var listScoresResponseSchema = v4.z.object({
  pagination: chunkAHAX7NUG_cjs.paginationInfoSchema,
...
function spanToTrajectorySteps(node) {
  ...
  switch (span.spanType) {
    ...
    case "provider_tool_call" /* PROVIDER_TOOL_CALL */: {
      const toolArgs = toRecordOrUndefined(span.input);
      const toolResult = toRecordOrUndefined(span.output);
      return [
        {
...
var spanTypeField = v4.z.nativeEnum(chunkAHAX7NUG_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
...
var sharedFields = {
  ...chunkAHAX7NUG_cjs.spanContextFields,
  metadata: chunkAHAX7NUG_cjs.metadataField.nullish(),
  tags: chunkAHAX7NUG_cjs.tagsField.nullish()
};
var spanIds = {
  traceId: chunkAHAX7NUG_cjs.traceIdField,
  spanId: chunkAHAX7NUG_cjs.spanIdField
};
var spanIdsSchema = v4.z.object({
  ...spanIds
});
var omitDbTimestamps = createOmitKeys(chunkAHAX7NUG_cjs.dbTimestamps);
...
var getSpanArgsSchema = v4.z.object({
  traceId: chunkAHAX7NUG_cjs.traceIdField.min(1),
  spanId: chunkAHAX7NUG_cjs.spanIdField.min(1)
...
var getSpansArgsSchema = v4.z.object({
  traceId: chunkAHAX7NUG_cjs.traceIdField.min(1),
  spanIds: v4.z.array(chunkAHAX7NUG_cjs.spanIdField.min(1)).min(1).describe("Span IDs to fetch within the trace")
...
var lightSpanRecordSchema = v4.z.object({
  ...
  entityType: chunkAHAX7NUG_cjs.spanContextFields.entityType,
  entityId: chunkAHAX7NUG_cjs.spanContextFields.entityId,
  entityName: chunkAHAX7NUG_cjs.spanContextFields.entityName,
  // Database timestamps
  ...chunkAHAX7NUG_cjs.dbTimestamps
}).describe(
...
var tracesFilterSchema = v4.z.object({
  // Date range filters
  startedAt: chunkAHAX7NUG_cjs.dateRangeSchema.optional().describe("Filter by span start time range"),
  endedAt: chunkAHAX7NUG_cjs.dateRangeSchema.optional().describe("Filter by span end time range"),
  // Span type filter
  spanType: spanTypeField.optional(),
  // Identifier filter (matches the root span's trace identifier)
  traceId: chunkAHAX7NUG_cjs.traceIdField.optional().describe("Filter by trace ID (matches root span)"),
  // Shared fields
  ...sharedFields,
...
var tracesOrderBySchema = v4.z.object({
  ...
  direction: chunkAHAX7NUG_cjs.sortDirectionSchema.default("DESC").describe("Sort direction")
}).describe("Order by configuration");
var listTracesArgsSchema = v4.z.object({
  mode: chunkAHAX7NUG_cjs.listModeSchema.optional(),
  filters: tracesFilterSchema.optional().describe("Optional filters to apply"),
  pagination: chunkAHAX7NUG_cjs.paginationArgsSchema.optional(),
  orderBy: tracesOrderBySchema.optional(),
  after: chunkAHAX7NUG_cjs.deltaCursorSchema.optional(),
  limit: chunkAHAX7NUG_cjs.deltaLimitSchema
}).strict().superRefine(chunkAHAX7NUG_cjs.refineObservabilityListMode).transform(
  (value) => chunkAHAX7NUG_cjs.normalizeObservabilityListArgs(value, {
    orderBy: { field: "startedAt", direction: "DESC" }
  })
).describe("Arguments for listing traces.");
var listTracesResponseSchema = v4.z.object({
  pagination: chunkAHAX7NUG_cjs.paginationInfoSchema.optional(),
  delta: chunkAHAX7NUG_cjs.deltaInfoSchema.optional(),
  deltaCursor: chunkAHAX7NUG_cjs.deltaCursorSchema.optional(),
...
var branchesFilterSchema = v4.z.object({
  ...
  spanType: spanTypeField.optional(),
  // Identifier filters
  traceId: chunkAHAX7NUG_cjs.traceIdField.optional().describe("Filter by parent trace ID"),
...
var listBranchesArgsSchema = v4.z.object({
  ...
  (value) => chunkAHAX7NUG_cjs.normalizeObservabilityListArgs(
    value,
    {
      orderBy: { field: "startedAt", direction: "DESC" }
    }
...
var batchDeleteTracesArgsSchema = v4.z.object({
  traceIds: v4.z.array(chunkAHAX7NUG_cjs.traceIdField)
...
var scoreTracesRequestSchema = v4.z.object({
  ...
  targets: v4.z.array(
    v4.z.object({
      traceId: chunkAHAX7NUG_cjs.traceIdField,
      spanId: chunkAHAX7NUG_cjs.spanIdField.optional()
    })
  ).min(1)
});
...
//# sourceMappingURL=chunk-XMQFQRE2.cjs.map
//# sourceMappingURL=chunk-XMQFQRE2.cjs.map