...
var MCPClientsStorage = class extends chunkFJFMJDFF_cjs.VersionedStorageDomain {
  listKey = "mcpClients";
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      configs = configs.filter((config) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkHEE7C2GC_cjs.deepEqual(config.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-CJUJT4JS.cjs.map
//# sourceMappingURL=chunk-CJUJT4JS.cjs.map