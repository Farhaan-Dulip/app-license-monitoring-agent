...
var provider_registry_default = {
  providers: {
    ...
    trustedrouter: {
      ...
      apiKeyHeader: "Authorization",
      name: "TrustedRouter",
      models: ["auto", "cheap", "e2e", "fast", "synth", "synth-code", "zdr"],
    ...
    "stepfun-ai-step-plan": {
      ...
      models: ["step-3.5-flash", "step-3.5-flash-2603", "step-3.7-flash"],
    ...
    poolside: {
      ...
      apiKeyHeader: "Authorization",
      name: "Poolside",
      models: ["poolside/laguna-m.1", "poolside/laguna-xs-2.1", "poolside/laguna-xs.2"],
    ...
    "ai-router": {
      ...
      apiKeyHeader: "Authorization",
      name: "AI-ROUTER",
      models: ["gpt-5.4", "gpt-5.5", "gpt-5.6-luna", "gpt-5.6-sol", "gpt-5.6-terra"],
    ...
    "stepfun-step-plan": {
      ...
      models: ["step-3.5-flash", "step-3.5-flash-2603", "step-3.7-flash", "step-router-v1"],
    ...
    xpersona: {
      ...
      apiKeyHeader: "Authorization",
      name: "Xpersona",
      models: ["claude-fable-5", "xpersona-frieren-coder", "xpersona-gpt-5.5"],
    ...
    "wafer.ai": {
      ...
      apiKeyHeader: "Authorization",
      name: "Wafer",
      models: ["GLM-5.1", "GLM-5.2", "Kimi-K2.6", "MiniMax-M3", "glm5.2-fast"],
  ...
  models: {
    ...
    ebcloud: ["DeepSeek-V4-Flash", "DeepSeek-V4-Pro", "GLM-5.1", "Kimi-K2.6"],
    "alibaba-token-plan-cn": [
      "MiniMax-M2.5",
      "deepseek-v3.2",
      "deepseek-v4-flash",
    ...
    trustedrouter: ["auto", "cheap", "e2e", "fast", "synth", "synth-code", "zdr"],
    zhipuai: [
      "glm-4.5",
      "glm-4.5-air",
      "glm-4.5-flash",
    ...
    "stepfun-ai-step-plan": ["step-3.5-flash", "step-3.5-flash-2603", "step-3.7-flash"],
    lmstudio: ["openai/gpt-oss-20b", "qwen/qwen3-30b-a3b-2507", "qwen/qwen3-coder-30b"],
    poolside: ["poolside/laguna-m.1", "poolside/laguna-xs-2.1", "poolside/laguna-xs.2"],
    ...
    "ai-router": ["gpt-5.4", "gpt-5.5", "gpt-5.6-luna", "gpt-5.6-sol", "gpt-5.6-terra"],
    "io-net": [
      "Intel/Qwen3-Coder-480B-A35B-Instruct-int4-mixed-ar",
      "Qwen/Qwen2.5-VL-32B-Instruct",
      "Qwen/Qwen3-235B-A22B-Thinking-2507",
    ...
    "stepfun-step-plan": ["step-3.5-flash", "step-3.5-flash-2603", "step-3.7-flash", "step-router-v1"],
    xpersona: ["claude-fable-5", "xpersona-frieren-coder", "xpersona-gpt-5.5"],
    baseten: [
      "deepseek-ai/DeepSeek-V4-Pro",
      "moonshotai/Kimi-K2.5",
      "moonshotai/Kimi-K2.6",
    ...
    "wafer.ai": ["GLM-5.1", "GLM-5.2", "Kimi-K2.6", "MiniMax-M3", "glm5.2-fast"],
    minimax: [
      "MiniMax-M2",
      "MiniMax-M2.1",
      "MiniMax-M2.5",
...
var staticRegistry = provider_registry_default;
...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-LIS73MSY.cjs', document.baseURI).href)) || "file://");
...
function loadRegistry(useDynamicLoading, customGateways = []) {
  const enabledGatewayIds = getEnabledGatewayIds([
    new chunkO5UD5NQL_cjs.ModelsDevGateway({}),
...
var parsedCapFileCache = /* @__PURE__ */ new Map();
...
function _resetCapabilityCaches() {
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-73NJD6MV.cjs');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-TBTBLQGL.cjs');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-L7LY3IIB.cjs');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-FKJPU4VZ.cjs');
      ...
      const { providers, models, attachmentCapabilities, temperatureCapabilities, failedGateways } = await fetchProvidersFromGateways(gateways);
...
var MastraGateway = class extends chunk5YQHHVJF_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
  }
  ...
  resolveLanguageModel({
    ...
    if (this.config?.customFetch && providerId === "anthropic") {
      return chunk5YQHHVJF_cjs.createAnthropic({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunk5YQHHVJF_cjs.MASTRA_USER_AGENT,
          [chunk5YQHHVJF_cjs.GATEWAY_AUTH_HEADER]: `Bearer ${apiKey}`,
          ...headers
        },
    ...
    if (this.config?.customFetch) {
      return chunkO5UD5NQL_cjs.createOpenRouter({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunk5YQHHVJF_cjs.MASTRA_USER_AGENT,
...
exports._resetCapabilityCaches = _resetCapabilityCaches;
...
//# sourceMappingURL=chunk-LIS73MSY.cjs.map
//# sourceMappingURL=chunk-LIS73MSY.cjs.map