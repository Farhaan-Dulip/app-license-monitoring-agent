import { NetlifyGateway } from './chunk-BCY2HFG2.js';
import { ModelsDevGateway, createOpenRouter } from './chunk-OLSGZFOG.js';
import { MastraModelGateway, createAnthropic, MASTRA_USER_AGENT, GATEWAY_AUTH_HEADER } from './chunk-QD7SPEJN.js';
import { MastraError } from './chunk-HJNLTRHA.js';
import fs from 'fs';
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-77XQDNJI.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-MDQZF2QN.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-KKXRMOU3.js');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-RF5W4XV5.js');
...
export { GatewayRegistry, MastraGateway, PROVIDER_MODELS, PROVIDER_REGISTRY, _resetCapabilityCaches, findGatewayForModel, getGatewayId, getProviderConfig, getRegisteredProviders, isOfflineMode, isProviderRegistered, isValidModelId, modelSupportsAttachments, modelSupportsTemperature, parseModelString, shouldEnableGateway };
//# sourceMappingURL=chunk-YY2AFOL6.js.map
//# sourceMappingURL=chunk-YY2AFOL6.js.map