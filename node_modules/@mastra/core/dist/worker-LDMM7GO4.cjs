...
var AgentScheduleWorker = class extends chunkCWKMGK5K_cjs.MastraWorker {
  name = "agent-schedule";
  #config;
  #transport;
  #pushCb;
...
function buildIfIdleOptions(ifIdle) {
  ...
  return {
    ...
    ...requestContext ? { streamOptions: { requestContext: new chunkD2FOXUYM_cjs.RequestContext(Object.entries(requestContext)) } } : {}
  };
}
...
exports.TOPIC_AGENT_SCHEDULES = TOPIC_AGENT_SCHEDULES;
exports.executeAgentSchedule = executeAgentSchedule;
//# sourceMappingURL=worker-LDMM7GO4.cjs.map
//# sourceMappingURL=worker-LDMM7GO4.cjs.map