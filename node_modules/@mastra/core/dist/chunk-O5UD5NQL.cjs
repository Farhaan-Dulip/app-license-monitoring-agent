...
var chunk5YQHHVJF_cjs = require('./chunk-5YQHHVJF.cjs');
var chunk4MB5NE52_cjs = require('./chunk-4MB5NE52.cjs');
var v4 = require('zod/v4');

// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/openai-compatible/2.0.59/716e6edf6b2408d16eadd5cc918d701118c9c65f00e28dccdcdc79099095dbee/node_modules/@ai-sdk/openai-compatible/dist/internal/index.mjs
...
function prepareTools({
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new chunk5YQHHVJF_cjs.UnsupportedFunctionalityError2({
...
var alibabaFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler2({
...
function formatImageUrl({
  ...
  return data instanceof URL ? data.toString() : `data:${mediaType};base64,${chunk5YQHHVJF_cjs.convertToBase642(data)}`;
}
...
var AlibabaLanguageModel = class {
  ...
  async getArgs({
    ...
    const alibabaOptions = await chunk5YQHHVJF_cjs.parseProviderOptions2({
      provider: "alibaba",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    } = await chunk5YQHHVJF_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/chat/completions`,
      headers: chunk5YQHHVJF_cjs.combineHeaders2(this.config.headers(), options.headers),
      body: args,
      failedResponseHandler: alibabaFailedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createJsonResponseHandler2(
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk5YQHHVJF_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/chat/completions`,
      headers: chunk5YQHHVJF_cjs.combineHeaders2(this.config.headers(), options.headers),
      body,
      failedResponseHandler: alibabaFailedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createEventSourceResponseHandler2(
          ...
          transform(chunk, controller) {
            ...
            if (delta.reasoning_content != null && delta.reasoning_content.length > 0) {
              if (activeReasoningId == null) {
                ...
                activeReasoningId = chunk5YQHHVJF_cjs.generateId2();
                controller.enqueue({
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunk5YQHHVJF_cjs.InvalidResponseDataError2({
                      data: toolCallDelta,
...
var alibabaEmbeddingModelOptions = v4.z.object({
   ...
   */
  outputType: v4.z.enum(["dense", "sparse", "dense&sparse"]).optional()
});
var alibabaEmbeddingFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler2({
  errorSchema: v4.z.object({
    code: v4.z.string().nullish(),
    message: v4.z.string(),
...
var AlibabaEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunk5YQHHVJF_cjs.TooManyEmbeddingValuesForCallError2({
    ...
    const {
      ...
      headers: chunk5YQHHVJF_cjs.combineHeaders2(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: {
          texts: values
...
var alibabaTextEmbeddingSparseEmbeddingSchema = v4.z.object({
  index: v4.z.number(),
  value: v4.z.number(),
  token: v4.z.string().nullish()
});
var alibabaTextEmbeddingResponseSchema = v4.z.object({
  output: v4.z.object({
    embeddings: v4.z.array(
      v4.z.object({
        embedding: v4.z.array(v4.z.number()),
        text_index: v4.z.number(),
        sparse_embedding: v4.z.array(alibabaTextEmbeddingSparseEmbeddingSchema).nullish()
      })
    )
  }),
  usage: v4.z.object({
...
var alibabaVideoModelOptionsSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
      ...
      media: v4.z.array(
        v4.z.object({
          ...
          url: v4.z.string(),
          referenceVoice: v4.z.string().nullish()
        })
      ).nullish(),
      ratio: v4.z.enum(["16:9", "9:16", "1:1", "4:3", "3:4"]).nullish(),
...
var alibabaVideoFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler2({
...
function fileToImageString(file) {
  ...
  return typeof file.data === "string" ? file.data : chunk5YQHHVJF_cjs.convertUint8ArrayToBase642(file.data);
}
function getFirstFrameImage(options) {
  var _a15, _b;
  return (_b = (_a15 = options.frameImages) == null ? void 0 : _a15.find((frame) => frame.frameType === "first_frame")) == null ? void 0 : _b.image;
}
function resolveStartImage(options) {
  var _a15;
  return (_a15 = getFirstFrameImage(options)) != null ? _a15 : options.image;
}
...
function resolveMedia(options, alibabaOptions, warnings) {
  ...
  const media = [];
  for (const reference of (_a15 = options.inputReferences) != null ? _a15 : []) {
    if (reference.type === "url") {
      ...
      media.push({
        ...
        url: chunk5YQHHVJF_cjs.convertImageModelFileToDataUri(reference)
      });
    } else {
      warnings.push({
        type: "unsupported",
  ...
  if (firstFrame != null) {
    media.push({
      type: "first_frame",
      url: chunk5YQHHVJF_cjs.convertImageModelFileToDataUri(firstFrame)
    });
  }
...
function resolveReferenceUrls(options, alibabaOptions, warnings) {
  ...
  return (_a15 = alibabaOptions == null ? void 0 : alibabaOptions.referenceUrls) != null ? _a15 : void 0;
}
var AlibabaVideoModel = class {
  ...
  async doGenerate(options) {
    ...
    const { value: createResponse } = await chunk5YQHHVJF_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/api/v1/services/aigc/video-generation/video-synthesis`,
      headers: chunk5YQHHVJF_cjs.combineHeaders2(
        await chunk5YQHHVJF_cjs.resolve2(this.config.headers),
        options.headers,
        {
    ...
    if (!taskId) {
      throw new chunk5YQHHVJF_cjs.AISDKError({
    ...
    let responseHeaders;
    while (true) {
      await chunk5YQHHVJF_cjs.delay(pollIntervalMs, { abortSignal: options.abortSignal });
      ...
      const { value: statusResponse, responseHeaders: pollHeaders } = await chunk5YQHHVJF_cjs.getFromApi({
...
function createAlibaba(options = {}) {
  var _a15, _b, _c;
  const baseURL = (_a15 = chunk5YQHHVJF_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
  const videoBaseURL = (_b = chunk5YQHHVJF_cjs.withoutTrailingSlash2(options.videoBaseURL)) != null ? _b : "https://dashscope-intl.aliyuncs.com";
  const embeddingBaseURL = (_c = chunk5YQHHVJF_cjs.withoutTrailingSlash2(options.embeddingBaseURL)) != null ? _c : "https://dashscope-intl.aliyuncs.com/api/v1";
  const getHeaders = () => chunk5YQHHVJF_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunk5YQHHVJF_cjs.loadApiKey2({
  ...
  provider.imageModel = (modelId) => {
    throw new chunk5YQHHVJF_cjs.NoSuchModelError2({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createAlibaba();
...
function createCerebras(options = {}) {
  var _a15;
  const baseURL = chunk5YQHHVJF_cjs.withoutTrailingSlash(
    (_a15 = options.baseURL) != null ? _a15 : "https://api.cerebras.ai/v1"
  );
  const getHeaders = () => chunk5YQHHVJF_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunk5YQHHVJF_cjs.loadApiKey({
        apiKey: options.apiKey,
  ...
  const createLanguageModel = (modelId) => {
    return new chunk5YQHHVJF_cjs.OpenAICompatibleChatLanguageModel(modelId, {
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunk5YQHHVJF_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
  provider.imageModel = (modelId) => {
    throw new chunk5YQHHVJF_cjs.NoSuchModelError({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createCerebras();
var DeepInfraImageModel = class {
  ...
  async doGenerate({
    ...
    const currentDate = (_c = (_b = (_a15 = this.config._internal) == null ? void 0 : _a15.currentDate) == null ? void 0 : _b.call(_a15)) != null ? _c : /* @__PURE__ */ new Date();
    const { value: response, responseHeaders } = await chunk5YQHHVJF_cjs.postJsonToApi({
      url: `${this.config.baseURL}/${this.modelId}`,
      headers: chunk5YQHHVJF_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        prompt,
        num_images: n,
      ...
      failedResponseHandler: chunk5YQHHVJF_cjs.createJsonErrorResponseHandler({
        errorSchema: deepInfraErrorSchema,
        errorToMessage: (error) => error.detail.error
      }),
      successfulResponseHandler: chunk5YQHHVJF_cjs.createJsonResponseHandler(
...
var DeepInfraChatLanguageModel = class extends chunk5YQHHVJF_cjs.OpenAICompatibleChatLanguageModel {
  constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
  ...
  const createCompletionModel = (modelId) => new chunk5YQHHVJF_cjs.OpenAICompatibleCompletionLanguageModel(
    modelId,
    getCommonModelConfig("completion")
  );
  const createTextEmbeddingModel = (modelId) => new chunk5YQHHVJF_cjs.OpenAICompatibleEmbeddingModel(
    modelId,
...
var deepseekChatChunkSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
        created: v4.z.number().nullish(),
...
var deepseekChatOptions = v4.z.object({
  ...
  thinking: v4.z.object({
    type: v4.z.enum(["adaptive", "enabled", "disabled"]).optional()
  }).optional(),
  /**
   ...
   */
  reasoningEffort: v4.z.enum(["low", "medium", "high", "xhigh", "max"]).optional()
});
function prepareTools2({
  ...
  switch (type) {
    ...
    default: {
      const _exhaustiveCheck = type;
      throw new chunk5YQHHVJF_cjs.UnsupportedFunctionalityError({
        functionality: `tool choice type: ${_exhaustiveCheck}`
      });
    }
  }
...
var DeepSeekChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.failedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler({
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await chunk5YQHHVJF_cjs.parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      value: responseBody,
      rawValue: rawResponse
    } = await chunk5YQHHVJF_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunk5YQHHVJF_cjs.combineHeaders(this.config.headers(), options.headers),
      body: args,
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunk5YQHHVJF_cjs.generateId(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk5YQHHVJF_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: this.failedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createEventSourceResponseHandler(
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunk5YQHHVJF_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                      message: `Expected 'id' to be a string.`
                    });
                  }
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunk5YQHHVJF_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunk5YQHHVJF_cjs.generateId(),
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunk5YQHHVJF_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunk5YQHHVJF_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
            ...
            switch (part.type) {
              ...
              case "file": {
                ...
                return {
                  type: "image_url",
                  image_url: {
                    url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunk5YQHHVJF_cjs.convertToBase642(part.data)}`
                  }
                };
              }
            }
        ...
        for (const toolResponse of content) {
          ...
          switch (output.type) {
            ...
            case "error-text":
              ...
              break;
            case "execution-denied":
              contentValue = (_a15 = output.reason) != null ? _a15 : "Tool call execution denied.";
              break;
            case "content":
            case "json":
            case "error-json":
...
var groqFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler2({
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b, _c;
    const warnings = [];
    const groqOptions = await chunk5YQHHVJF_cjs.parseProviderOptions2({
      provider: "groq",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunk5YQHHVJF_cjs.generateId2(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk5YQHHVJF_cjs.postJsonToApi2({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createEventSourceResponseHandler2(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const toolCalls = [];
...
var groqTranscriptionModelOptions = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
...
var GroqTranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunk5YQHHVJF_cjs.convertBase64ToUint8Array2(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunk5YQHHVJF_cjs.mediaTypeToExtension2(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunk5YQHHVJF_cjs.postFormDataToApi2({
      url: this.config.url({
...
var browserSearch = chunk5YQHHVJF_cjs.createProviderToolFactory({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunk5YQHHVJF_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => chunk5YQHHVJF_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunk5YQHHVJF_cjs.loadApiKey2({
        apiKey: options.apiKey,
  ...
  provider.embeddingModel = (modelId) => {
    throw new chunk5YQHHVJF_cjs.NoSuchModelError2({ modelId, modelType: "embeddingModel" });
  };
...
var mistralFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler2({
...
var MistralChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a15 = config.generateId) != null ? _a15 : chunk5YQHHVJF_cjs.generateId2;
  }
  get provider() {
    return this.config.provider;
  }
  async getArgs({
    ...
    var _a15, _b, _c, _d;
    const warnings = [];
    const options = (_a15 = await chunk5YQHHVJF_cjs.parseProviderOptions2({
      provider: "mistral",
      providerOptions,
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) {
      prompt = chunk5YQHHVJF_cjs.injectJsonInstructionIntoMessages({
        messages: prompt,
        schema: responseFormat.schema
      });
    }
...
function createMistral(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunk5YQHHVJF_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => chunk5YQHHVJF_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunk5YQHHVJF_cjs.loadApiKey2({
        apiKey: options.apiKey,
            ...
            case "file": {
              if (part.mediaType === "application/pdf") {
                return part.data instanceof URL ? {
                  ...
                  type: "file_url",
                  file_url: {
                    url: typeof part.data === "string" ? part.data : chunk5YQHHVJF_cjs.convertUint8ArrayToBase64(part.data)
                  },
                ...
                return part.data instanceof URL ? {
                  ...
                  type: "image_url",
                  image_url: {
                    url: `data:${(_a15 = part.mediaType) != null ? _a15 : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : chunk5YQHHVJF_cjs.convertUint8ArrayToBase64(part.data)}`
                  }
                };
              }
            }
...
function createPerplexity(options = {}) {
  ...
  const createLanguageModel = (modelId) => {
    ...
    return new PerplexityLanguageModel(modelId, {
      baseURL: chunk5YQHHVJF_cjs.withoutTrailingSlash(
        (_a15 = options.baseURL) != null ? _a15 : "https://api.perplexity.ai"
      ),
      headers: getHeaders,
      generateId: chunk5YQHHVJF_cjs.generateId,
      fetch: options.fetch
    });
  };
  const provider = (modelId) => createLanguageModel(modelId);
...
function createTogetherAI(options = {}) {
  ...
  const getHeaders = () => {
    var _a22;
    return chunk5YQHHVJF_cjs.withUserAgentSuffix(
      {
        Authorization: `Bearer ${chunk5YQHHVJF_cjs.loadApiKey({
  ...
  const createChatModel = (modelId) => {
    return new chunk5YQHHVJF_cjs.OpenAICompatibleChatLanguageModel(
      modelId,
      getCommonModelConfig("chat")
    );
  };
...
createTogetherAI();
var xaiFilePartProviderOptions = v4.z.object({
  /**
   ...
   */
  imageDetail: v4.z.enum(["low", "high", "auto"]).optional()
});
        ...
        for (const part of content) {
          switch (part.type) {
            ...
            case "file": {
              if (part.mediaType.startsWith("image/")) {
                const mediaType = part.mediaType === "image/*" ? "image/jpeg" : part.mediaType;
                const filePartOptions = await chunk5YQHHVJF_cjs.parseProviderOptions2({
                  provider: "xai",
...
var xaiLanguageModelChatOptions = v4.z.object({
  reasoningEffort: v4.z.enum(["none", "low", "medium", "high"]).optional(),
...
var chatCompletionsErrorSchema = v4.z.object({
  error: v4.z.object({
    message: v4.z.string(),
    type: v4.z.string().nullish(),
    param: v4.z.any().nullish(),
...
var responsesErrorSchema = v4.z.object({
  code: v4.z.string(),
  error: v4.z.string()
});
var xaiErrorDataSchema = v4.z.union([
  chatCompletionsErrorSchema,
  responsesErrorSchema
]);
var xaiFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler2({
...
var XaiChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error != null) {
      throw new chunk5YQHHVJF_cjs.APICallError2({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk5YQHHVJF_cjs.postJsonToApi2({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        const responseHeaders2 = chunk5YQHHVJF_cjs.extractResponseHeaders(response2);
        const contentType = response2.headers.get("content-type");
        if (contentType == null ? void 0 : contentType.includes("application/json")) {
          const responseBody = await response2.text();
          const parsedError = await chunk5YQHHVJF_cjs.safeParseJSON({
            text: responseBody,
        ...
        return chunk5YQHHVJF_cjs.createEventSourceResponseHandler2(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
...
var XaiImageModel = class {
  ...
  async doGenerate({
    ...
    const xaiOptions = await chunk5YQHHVJF_cjs.parseProviderOptions2({
      provider: "xai",
      providerOptions,
      schema: xaiImageModelOptions
    });
    const hasFiles = files != null && files.length > 0;
    const imageUrls = hasFiles ? files.map((file) => chunk5YQHHVJF_cjs.convertImageModelFileToDataUri(file)) : [];
    ...
    const { value: response, responseHeaders } = await chunk5YQHHVJF_cjs.postJsonToApi2({
  ...
  async downloadImage(url, abortSignal) {
    const { value } = await chunk5YQHHVJF_cjs.getFromApi({
      url,
      abortSignal,
      failedResponseHandler: chunk5YQHHVJF_cjs.createStatusCodeErrorResponseHandler(),
      successfulResponseHandler: chunk5YQHHVJF_cjs.createBinaryResponseHandler2(),
      fetch: this.config.fetch
    });
    return value;
  }
          ...
          switch (block.type) {
            ...
            case "file": {
              if (block.mediaType.startsWith("image/")) {
                ...
                const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${chunk5YQHHVJF_cjs.convertToBase642(block.data)}`;
                const filePartOptions = await chunk5YQHHVJF_cjs.parseProviderOptions2({
                  provider: "xai",
...
var outputItemSchema = v4.z.discriminatedUnion("type", [
  ...
  v4.z.object({
    ...
    content: v4.z.array(v4.z.object({ type: v4.z.string(), text: v4.z.string() })).nullish(),
    status: v4.z.string(),
...
var fileSearchArgsSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchOutputSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchToolFactory = chunk5YQHHVJF_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.file_search",
  inputSchema: chunk5YQHHVJF_cjs.lazySchema2(() => chunk5YQHHVJF_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: fileSearchOutputSchema
});
var fileSearch = (args) => fileSearchToolFactory(args);
var mcpServerArgsSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
...
var mcpServerOutputSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
      name: v4.z.string(),
      arguments: v4.z.string(),
...
var mcpServerToolFactory = chunk5YQHHVJF_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.mcp",
  inputSchema: chunk5YQHHVJF_cjs.lazySchema2(() => chunk5YQHHVJF_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: mcpServerOutputSchema
});
var mcpServer = (args) => mcpServerToolFactory(args);
var webSearchArgsSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
      allowedDomains: v4.z.array(v4.z.string()).max(5).optional(),
      excludedDomains: v4.z.array(v4.z.string()).max(5).optional(),
      enableImageSearch: v4.z.boolean().optional(),
      enableImageUnderstanding: v4.z.boolean().optional()
    })
  )
);
var webSearchOutputSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      sources: v4.z.array(
...
var webSearchToolFactory = chunk5YQHHVJF_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.web_search",
  inputSchema: chunk5YQHHVJF_cjs.lazySchema2(() => chunk5YQHHVJF_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
...
var xSearchOutputSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      posts: v4.z.array(
...
var xSearchToolFactory = chunk5YQHHVJF_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.x_search",
  inputSchema: chunk5YQHHVJF_cjs.lazySchema2(() => chunk5YQHHVJF_cjs.zodSchema2(v4.z.object({}))),
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await chunk5YQHHVJF_cjs.validateTypes2({
            value: tool.args,
...
var codeExecutionToolFactory = chunk5YQHHVJF_cjs.createProviderToolFactoryWithOutputSchema({
...
var viewImageToolFactory = chunk5YQHHVJF_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_image",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = chunk5YQHHVJF_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var xaiVideoModelOptionsSchema = chunk5YQHHVJF_cjs.lazySchema2(
  () => chunk5YQHHVJF_cjs.zodSchema2(runtimeSchema)
);
var RESOLUTION_MAP = {
  "1280x720": "720p",
  "854x480": "480p",
...
function getLastFrameImage(options) {
  var _a15, _b;
  return (_b = (_a15 = options.frameImages) == null ? void 0 : _a15.find((frame) => frame.frameType === "last_frame")) == null ? void 0 : _b.image;
}
function resolveStartImage2(options) {
  var _a15;
  return (_a15 = getFirstFrameImage2(options)) != null ? _a15 : options.image;
}
...
function fileToXaiImageUrl(file) {
  ...
  const base64Data = typeof file.data === "string" ? file.data : chunk5YQHHVJF_cjs.convertUint8ArrayToBase642(file.data);
...
function createXai(options = {}) {
  var _a15;
  const baseURL = chunk5YQHHVJF_cjs.withoutTrailingSlash2(
  ...
  const createChatLanguageModel = (modelId) => {
    return new XaiChatLanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: chunk5YQHHVJF_cjs.generateId2,
      fetch: options.fetch
    });
  };
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_g = toolCall2.function) == null ? void 0 : _g.name) != null && ((_h = toolCall2.function) == null ? void 0 : _h.arguments) != null && isParsableJson2(toolCall2.function.arguments)) {
...
var ModelsDevGateway = class extends chunk5YQHHVJF_cjs.MastraModelGateway {
  id = "models.dev";
  name = "models.dev";
  providerConfigs = {};
  ...
  async fetchProviders() {
    ...
    for (const [providerId, providerInfo] of Object.entries(data)) {
      if (chunk5YQHHVJF_cjs.EXCLUDED_PROVIDERS.includes(providerId)) continue;
      ...
      const hasInstalledPackage = chunk5YQHHVJF_cjs.PROVIDERS_WITH_INSTALLED_PACKAGES.includes(providerId);
      ...
      if (isOpenAICompatible || hasInstalledPackage || hasApiAndEnv) {
        ...
        const temperatureModels = activeModels.filter(([, modelInfo]) => modelInfo?.temperature === true).map(([modelId]) => modelId).sort();
  ...
  async resolveLanguageModel({
    ...
    const mastraHeaders = { "User-Agent": chunk5YQHHVJF_cjs.MASTRA_USER_AGENT, ...headers };
    const override = this.providerConfigs[providerId]?.modelOverrides?.[modelId];
    if (override?.shape === "responses") {
      return chunk5YQHHVJF_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
    }
    switch (providerId) {
      case "openai":
        return chunk5YQHHVJF_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
      case "gemini":
      case "google":
        return chunk5YQHHVJF_cjs.createGoogleGenerativeAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
      case "anthropic":
        return chunk5YQHHVJF_cjs.createAnthropic({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      case "mistral":
      ...
      case "vercel":
        return chunk4MB5NE52_cjs.createGatewayProvider({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      case "moonshotai":
      case "moonshotai-cn": {
      ...
      default: {
        ...
        if (npm === "@ai-sdk/openai") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunk5YQHHVJF_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
        ...
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunk5YQHHVJF_cjs.createOpenAICompatible({
          name: providerId,
          apiKey,
          baseURL,
...
//# sourceMappingURL=chunk-O5UD5NQL.cjs.map
//# sourceMappingURL=chunk-O5UD5NQL.cjs.map