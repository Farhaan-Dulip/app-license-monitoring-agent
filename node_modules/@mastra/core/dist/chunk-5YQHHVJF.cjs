...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/provider-utils/3.0.28/6b6884bd8bd947122126c646774d218f63429357592ee42db4f10166caed45bd/node_modules/@ai-sdk/provider-utils/dist/index.mjs
var dist_exports = {};
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/provider/3.0.14/30b98effe2636d5b58b60cf37530a90112258d4490ff3a92f52c5cf16e4b475d/node_modules/@ai-sdk/provider/dist/index.mjs
...
function parseIPv62(ip) {
  ...
  const toGroups = (segment) => {
    ...
    for (let i = 0; i < parts.length; i++) {
      const part = parts[i];
      if (part.includes(".")) {
        if (i !== parts.length - 1 || !isIPv42(part)) return null;
        const [a, b, c, d] = part.split(".").map(Number);
        groups.push(a << 8 | b, c << 8 | d);
        continue;
      }
...
var MAX_DOWNLOAD_REDIRECTS2 = 10;
...
async function downloadBlob(url, options) {
  var _a23, _b23;
  try {
    const response = await fetchWithValidatedRedirects2({
      url,
      abortSignal: void 0 
    });
    if (!response.ok) {
...
function isSameOrigin2(url, baseUrl) {
  try {
    return new URL(url).origin === new URL(baseUrl).origin;
  } catch (e) {
    return false;
...
function asSchema2(schema) {
  return schema == null ? jsonSchema2({
    ...
    properties: {},
    additionalProperties: false
  }) : isSchema2(schema) ? schema : "~standard" in schema ? schema["~standard"].vendor === "zod" ? zodSchema2(schema) : standardSchema(schema) : schema();
}
...
function createOpenAIStreamError({
  ...
  return new APICallError2({
    message: (_a18 = streamError == null ? void 0 : streamError.message) != null ? _a18 : "OpenAI stream failed before any output was generated",
    url,
    requestBodyValues,
...
function parseStreamError(frame) {
  ...
  const error = (_a18 = asRecord(value.error)) != null ? _a18 : value;
...
function getPromptCacheBreakpoint(providerOptions) {
  var _a18;
  return (_a18 = providerOptions == null ? void 0 : providerOptions.openai) == null ? void 0 : _a18.promptCacheBreakpoint;
}
    ...
    switch (role) {
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    image_url: {
                      ...
                      detail: (_b23 = (_a23 = part.providerOptions) == null ? void 0 : _a23.openai) == null ? void 0 : _b23.imageDetail
                    },
                    ...promptCacheBreakpoint != null && {
                      prompt_cache_breakpoint: promptCacheBreakpoint
                    }
      ...
      case "tool": {
        for (const toolResponse of content) {
          ...
          const output = toolResponse.output;
          const promptCacheBreakpoint = (_a18 = output.type === "content" ? output.value.map((part) => getPromptCacheBreakpoint(part.providerOptions)).find((breakpoint) => breakpoint != null) : getPromptCacheBreakpoint(output.providerOptions)) != null ? _a18 : getPromptCacheBreakpoint(toolResponse.providerOptions);
          let contentValue;
          switch (output.type) {
            case "text":
            case "error-text":
            ...
            case "execution-denied":
              contentValue = (_b18 = output.reason) != null ? _b18 : "Tool call execution denied.";
              break;
            case "content":
            case "json":
            case "error-json":
  ...
  () => zodSchema2(
    z4.z.object({
      ...
      usage: z4.z.object({
        ...
        prompt_tokens_details: z4.z.object({
          cached_tokens: z4.z.number().nullish(),
          cache_write_tokens: z4.z.number().nullish()
        }).nullish(),
        completion_tokens_details: z4.z.object({
          reasoning_tokens: z4.z.number().nullish(),
          accepted_prediction_tokens: z4.z.number().nullish(),
...
var openaiLanguageModelChatOptions = lazySchema2(
  () => zodSchema2(
    z4.z.object({
       ...
       * Reasoning effort for reasoning models. Defaults to `medium`.
       */
      reasoningEffort: z4.z.enum(["none", "minimal", "low", "medium", "high", "xhigh", "max"]).optional(),
      /**
       ...
       */
      promptCacheOptions: z4.z.object({
        mode: z4.z.enum(["implicit", "explicit"]).optional(),
        ttl: z4.z.literal("30m").optional()
      }).optional(),
      /**
          ...
          flush(controller) {
            ...
            for (const toolCall of toolCalls) {
              if (!toolCall.hasFinished) {
                ...
                controller.enqueue({
                  type: "tool-call",
                  toolCallId: (_a18 = toolCall.id) != null ? _a18 : generateId2(),
                  toolName: toolCall.function.name,
                  input: toolCall.function.arguments
                });
                toolCall.hasFinished = true;
    ...
    z4.z.object({
      action: z4.z.discriminatedUnion("type", [
        z4.z.object({
          ...
          queries: z4.z.array(z4.z.string()).optional()
        }),
        z4.z.object({
...
function getPromptCacheBreakpoint2(providerOptions, providerOptionsName) {
  var _a18;
  return (_a18 = providerOptions == null ? void 0 : providerOptions[providerOptionsName]) == null ? void 0 : _a18.promptCacheBreakpoint;
}
...
async function convertToOpenAIResponsesInput({
  ...
  var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w;
  let input = [];
  const warnings = [];
      ...
      case "assistant": {
        ...
        for (const part of content) {
          switch (part.type) {
            ...
            case "reasoning": {
              const providerOptions2 = await parseProviderOptions2({
...
var openaiResponsesNestedErrorChunkSchema = z4.z.object({
...
var openaiResponsesErrorChunkSchema = z4.z.object({
  type: z4.z.literal("error"),
  sequence_number: z4.z.number(),
  code: z4.z.string().nullish(),
  message: z4.z.string(),
        ...
        response: z4.z.object({
          ...
          usage: z4.z.object({
            ...
            input_tokens_details: z4.z.object({
              cached_tokens: z4.z.number().nullish(),
              cache_write_tokens: z4.z.number().nullish(),
              orchestration_input_tokens: z4.z.number().nullish(),
              orchestration_input_cached_tokens: z4.z.number().nullish()
            }).nullish(),
            output_tokens: z4.z.number(),
            output_tokens_details: z4.z.object({
              reasoning_tokens: z4.z.number().nullish(),
              orchestration_output_tokens: z4.z.number().nullish()
            }).nullish()
          }),
          reasoning: z4.z.object({
            context: z4.z.string().nullish()
          }).nullish(),
          ...
          z4.z.object({
            ...
            action: z4.z.discriminatedUnion("type", [
              z4.z.object({
                ...
                queries: z4.z.array(z4.z.string()).nullish(),
                sources: z4.z.array(
                  z4.z.discriminatedUnion("type", [
                    z4.z.object({ type: z4.z.literal("url"), url: z4.z.string() }),
                    z4.z.object({ type: z4.z.literal("api"), name: z4.z.string() })
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
       ...
       */
      reasoningMode: z4.z.enum(["standard", "pro"]).optional(),
      /**
       ...
       */
      reasoningContext: z4.z.enum(["auto", "current_turn", "all_turns"]).optional(),
      /**
       ...
       */
      passThroughUnsupportedFiles: z4.z.boolean().optional(),
      /**
       * Whether to use strict JSON schema validation.
       * Defaults to `true`.
       */
...
var OpenAIResponsesLanguageModel = class {
  ...
  async doGenerate(options) {
    var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C;
    const {
      args: body,
      warnings,
      webSearchToolName,
    ...
    const result = {
      stream: checkedResponse.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
                  ...
                  if (output.type === "error-text" || output.type === "error-json") {
                    ...
                    try {
                      if (typeof output.value === "string") {
                        errorInfo = secureJsonParse2(output.value);
...
function normalizeBaseURL(baseURL) {
  const baseURLWithoutTrailingSlash = withoutTrailingSlash2(baseURL);
  return baseURLWithoutTrailingSlash === ANTHROPIC_API_URL ? ANTHROPIC_API_VERSIONED_URL : baseURLWithoutTrailingSlash;
}
function createAnthropic(options = {}) {
  var _a18, _b18;
  const baseURL = (_a18 = normalizeBaseURL(
    loadOptionalSetting2({
      settingValue: options.baseURL,
      environmentVariableName: "ANTHROPIC_BASE_URL"
    })
  )) != null ? _a18 : ANTHROPIC_API_VERSIONED_URL;
...
var MASTRA_USER_AGENT = `mastra/${"1.51.0"}` ;
                ...
                if (serverToolCallId && serverToolType) {
                  return {
                    toolCall: {
                      ...
                      args: typeof part.input === "string" ? secureJsonParse2(part.input) : part.input,
                      id: serverToolCallId
                    },
...
var googleLanguageModelOptions = lazySchema2(
  () => zodSchema2(
    z4.z.object({
       ...
       */
      sharedRequestType: z4.z.enum(["priority", "flex", "standard"]).optional(),
      /**
       ...
       * https://docs.cloud.google.com/vertex-ai/generative-ai/docs/priority-paygo
       */
      requestType: z4.z.enum(["shared"]).optional()
    })
  )
);
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async doGenerate(options) {
    var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r;
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerateGemini(options) {
    ...
    const googleImageOptions = await parseProviderOptions2({
      provider: "google",
      providerOptions,
      schema: googleImageModelOptionsSchema
    });
    const { googleSearch: _strippedGoogleSearch, ...passthroughGoogleOptions } = (_a18 = providerOptions == null ? void 0 : providerOptions.google) != null ? _a18 : {};
...
function getFirstFrameImage(options) {
  var _a18, _b18;
  return (_b18 = (_a18 = options.frameImages) == null ? void 0 : _a18.find((frame) => frame.frameType === "first_frame")) == null ? void 0 : _b18.image;
}
function resolveStartImage(options) {
  var _a18;
  return (_a18 = getFirstFrameImage(options)) != null ? _a18 : options.image;
}
function getLastFrameImage(options) {
  var _a18, _b18;
  return (_b18 = (_a18 = options.frameImages) == null ? void 0 : _a18.find((frame) => frame.frameType === "last_frame")) == null ? void 0 : _b18.image;
}
  ...
  async doGenerate(options) {
    ...
    for (const generatedSample of response.generateVideoResponse.generatedSamples) {
      if ((_h = generatedSample.video) == null ? void 0 : _h.uri) {
        const urlWithAuth = apiKey && isSameOrigin2(generatedSample.video.uri, this.config.baseURL) ? `${generatedSample.video.uri}${generatedSample.video.uri.includes("?") ? "&" : "?"}key=${apiKey}` : generatedSample.video.uri;
        videos.push({
          type: "url",
          url: urlWithAuth,
          mediaType: "video/mp4"
...
function annotationToSource({
  ...
  switch (annotation.type) {
    ...
    case "file_citation": {
      const a = annotation;
      const uri = (_b18 = (_a18 = a.url) != null ? _a18 : a.document_uri) != null ? _b18 : a.file_name;
      ...
      switch (eventType) {
        ...
        case "step.start": {
          ...
          if (stepType === "model_output") {
            const initial = (_a18 = step == null ? void 0 : step.content) == null ? void 0 : _a18[0];
...
var contentBlockSchema = () => {
  ...
  const videoContent = z4.z.object({
    type: z4.z.literal("video"),
    data: z4.z.string().nullish(),
    mime_type: z4.z.string().nullish(),
    uri: z4.z.string().nullish()
  }).loose();
...
var stepSchema = () => {
  const userInputStep = z4.z.object({
    type: z4.z.literal("user_input"),
    content: z4.z.array(contentBlockSchema()).nullish()
  }).loose();
  const modelOutputStep = z4.z.object({
    type: z4.z.literal("model_output"),
    content: z4.z.array(contentBlockSchema()).nullish()
  }).loose();
  const functionCallStep = z4.z.object({
    type: z4.z.literal("function_call"),
    id: z4.z.string(),
    name: z4.z.string(),
  ...
  const thoughtStep = z4.z.object({
    type: z4.z.literal("thought"),
    signature: z4.z.string().nullish(),
    summary: z4.z.array(thoughtSummaryItemSchema()).nullish()
  }).loose();
  const builtinToolCallStep = z4.z.object({
    type: z4.z.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
    id: z4.z.string(),
    arguments: z4.z.record(z4.z.string(), z4.z.unknown()).nullish(),
    name: z4.z.string().nullish(),
  ...
  const builtinToolResultStep = z4.z.object({
    type: z4.z.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
    call_id: z4.z.string(),
...
var googleInteractionsResponseSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      ...
      steps: z4.z.array(stepSchema()).nullish(),
...
var googleInteractionsEventSchema = lazySchema2(
  () => zodSchema2(
    (() => {
      ...
      const interactionCreatedEvent = z4.z.object({
        event_type: z4.z.literal("interaction.created"),
      ...
      const stepStartEvent = z4.z.object({
        event_type: z4.z.literal("step.start"),
        event_id: z4.z.string().nullish(),
        index: z4.z.number(),
        step: stepSchema()
      }).loose();
      const stepDeltaText = z4.z.object({
        type: z4.z.literal("text"),
        text: z4.z.string()
      }).loose();
      const stepDeltaThoughtSummary = z4.z.object({
        type: z4.z.literal("thought_summary"),
        content: thoughtSummaryItem.nullish()
      }).loose();
      const stepDeltaThoughtSignature = z4.z.object({
        type: z4.z.literal("thought_signature"),
        signature: z4.z.string().nullish()
      }).loose();
      const stepDeltaArgumentsDelta = z4.z.object({
        type: z4.z.literal("arguments_delta"),
        arguments: z4.z.string().nullish(),
        id: z4.z.string().nullish(),
        signature: z4.z.string().nullish()
      }).loose();
      const stepDeltaTextAnnotation = z4.z.object({
        type: z4.z.enum(["text_annotation_delta", "text_annotation"]),
        annotations: z4.z.array(annotation).nullish()
      }).loose();
      const stepDeltaImage = z4.z.object({
        type: z4.z.literal("image"),
        data: z4.z.string().nullish(),
        mime_type: z4.z.string().nullish(),
        resolution: z4.z.enum(["low", "medium", "high", "ultra_high"]).nullish(),
      ...
      const stepDeltaVideo = z4.z.object({
        type: z4.z.literal("video"),
        data: z4.z.string().nullish(),
        mime_type: z4.z.string().nullish(),
        uri: z4.z.string().nullish()
      }).loose();
      const stepDeltaBuiltinToolCall = z4.z.object({
        type: z4.z.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
        id: z4.z.string().nullish(),
        arguments: z4.z.record(z4.z.string(), z4.z.unknown()).nullish(),
        name: z4.z.string().nullish(),
      ...
      const stepDeltaBuiltinToolResult = z4.z.object({
        type: z4.z.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
        call_id: z4.z.string().nullish(),
        result: z4.z.unknown().nullish(),
        is_error: z4.z.boolean().nullish(),
      ...
      const stepDeltaUnknown = z4.z.object({ type: z4.z.string() }).loose();
      const stepDeltaUnion = z4.z.union([
        stepDeltaText,
        stepDeltaImage,
        stepDeltaVideo,
      ...
      const stepDeltaEvent = z4.z.object({
        event_type: z4.z.literal("step.delta"),
        event_id: z4.z.string().nullish(),
        index: z4.z.number(),
        delta: stepDeltaUnion
      }).loose();
      const stepStopEvent = z4.z.object({
        event_type: z4.z.literal("step.stop"),
        event_id: z4.z.string().nullish(),
        index: z4.z.number()
      }).loose();
      ...
      const interactionInProgressEvent = z4.z.object({
        event_type: z4.z.literal("interaction.in_progress"),
        event_id: z4.z.string().nullish(),
        interaction_id: z4.z.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionRequiresActionEvent = z4.z.object({
        event_type: z4.z.literal("interaction.requires_action"),
        event_id: z4.z.string().nullish(),
        interaction_id: z4.z.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionCompletedEvent = z4.z.object({
        event_type: z4.z.literal("interaction.completed"),
        event_id: z4.z.string().nullish(),
        interaction: z4.z.object({
          id: z4.z.string().nullish(),
          status: status.nullish(),
...
var googleInteractionsLanguageModelOptions = lazySchema2(
  () => zodSchema2(
    z4.z.object({
       ...
       */
      responseFormat: z4.z.array(
        z4.z.union([
          z4.z.object({
            type: z4.z.literal("text"),
            mimeType: z4.z.string().nullish(),
            schema: z4.z.unknown().nullish()
          }).loose(),
          z4.z.object({
            type: z4.z.literal("image"),
            mimeType: z4.z.string().nullish(),
       ...
       * requires.
       */
      background: z4.z.boolean().nullish(),
      /**
      ...
      environment: z4.z.union([
        z4.z.string(),
        z4.z.object({
          type: z4.z.literal("remote"),
          sources: z4.z.array(
            z4.z.union([
              z4.z.object({
                type: z4.z.literal("gcs"),
                source: z4.z.string(),
                target: z4.z.string().nullish()
              }),
              z4.z.object({
                type: z4.z.literal("repository"),
                source: z4.z.string(),
                target: z4.z.string().nullish()
              }),
              z4.z.object({
          ...
          network: z4.z.union([
            z4.z.literal("disabled"),
            z4.z.object({
              allowlist: z4.z.array(
                z4.z.object({
                  domain: z4.z.string(),
                  transform: z4.z.array(z4.z.record(z4.z.string(), z4.z.string())).nullish()
                })
              )
            })
          ]).nullish()
...
function parseGoogleInteractionsOutputs({
  ...
  for (const step of steps) {
    ...
    switch (type) {
      ...
      case "model_output": {
        const blocks = (_a18 = step.content) != null ? _a18 : [];
        for (const block of blocks) {
          if (block == null || typeof block !== "object") continue;
          const blockType = block.type;
          if (blockType === "text") {
            const text = (_b18 = block.text) != null ? _b18 : "";
...
var GoogleInteractionsLanguageModel = class {
  ...
  async getArgs(options) {
    var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z;
    const warnings = [];
...
//# sourceMappingURL=chunk-5YQHHVJF.cjs.map
//# sourceMappingURL=chunk-5YQHHVJF.cjs.map