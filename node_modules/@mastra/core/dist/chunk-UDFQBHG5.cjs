...
var AISDKSpeech = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    const result = await chunkHNRFQPHO_cjs.generateSpeech({
      model: this.model,
      text,
...
var AISDKTranscription = class extends MastraVoice {
  ...
  async listen(audioStream, options) {
    ...
    const result = await chunkHNRFQPHO_cjs.transcribe({
      model: this.model,
      audio: audioBuffer,
      providerOptions: options?.providerOptions,
      abortSignal: options?.abortSignal,
...
var CompositeVoice = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    throw new chunkZWNRICII_cjs.MastraError({
      ...
      domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VOICE,
...
//# sourceMappingURL=chunk-UDFQBHG5.cjs.map
//# sourceMappingURL=chunk-UDFQBHG5.cjs.map