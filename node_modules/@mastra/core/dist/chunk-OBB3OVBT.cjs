...
var chunkQK6OG7ZJ_cjs = require('./chunk-QK6OG7ZJ.cjs');
var chunkLIS73MSY_cjs = require('./chunk-LIS73MSY.cjs');
var chunk5YQHHVJF_cjs = require('./chunk-5YQHHVJF.cjs');
var chunkVJIIR3YT_cjs = require('./chunk-VJIIR3YT.cjs');
var chunkDVDSGBUW_cjs = require('./chunk-DVDSGBUW.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkVJIIR3YT_cjs.createStreamFromGenerateResult(result)
    };
  }
...
function normalizeFileDataForV4(data) {
  ...
  const { data: convertedData, mediaType } = chunkDVDSGBUW_cjs.convertToDataContent(data);
  return {
...
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    this.#manager = new chunkQK6OG7ZJ_cjs.GatewayManager([...customGateways ?? [], ...chunkQK6OG7ZJ_cjs.defaultGateways]);
  ...
  stripUnsupportedSamplingParams(options) {
    const supports = chunkLIS73MSY_cjs.modelSupportsTemperature(this.config.routerId);
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkVJIIR3YT_cjs.AISDKV5LanguageModel(model);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunk5YQHHVJF_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const wsFetch = chunkQK6OG7ZJ_cjs.createOpenAIWebSocketFetch({
      url: responsesWebSocket?.url,
      headers: responsesWebSocket?.headers
    });
    const modelInstance = chunk5YQHHVJF_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
function readGatewayStreamTransport(model) {
  return model[chunk5YQHHVJF_cjs.MASTRA_GATEWAY_STREAM_TRANSPORT];
}
...
async function resolveModelConfig(modelConfig, requestContext = new chunkD2FOXUYM_cjs.RequestContext(), mastra) {
  if (typeof modelConfig === "function") {
    modelConfig = await modelConfig({ requestContext, mastra });
  }
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof AISDKV4LegacyLanguageModel || modelConfig instanceof chunkVJIIR3YT_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel || modelConfig instanceof AISDKV7LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkVJIIR3YT_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var VERSION = "2.0.78" ;
var googleErrorDataSchema = chunk5YQHHVJF_cjs.lazySchema(
...
var googleFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler({
...
var googleGenerativeAIEmbeddingProviderOptions = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      /**
...
var GoogleGenerativeAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const googleOptions = await chunk5YQHHVJF_cjs.parseProviderOptions({
      provider: "google",
      providerOptions,
      schema: googleGenerativeAIEmbeddingProviderOptions
    });
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunk5YQHHVJF_cjs.TooManyEmbeddingValuesForCallError({
        provider: this.provider,
        modelId: this.modelId,
    ...
    const mergedHeaders = chunk5YQHHVJF_cjs.combineHeaders(
      await chunk5YQHHVJF_cjs.resolve(this.config.headers),
      headers
    );
...
var googleGenerativeAITextEmbeddingResponseSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var googleGenerativeAISingleEmbeddingResponseSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
            ...
            case "file": {
              ...
              parts.push(
                part.data instanceof URL ? {
                  ...
                  inlineData: {
                    mimeType: mediaType,
                    data: chunk5YQHHVJF_cjs.convertToBase64(part.data)
                  }
                }
              );
              break;
...
var googleGenerativeAIProviderOptions = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var GoogleGenerativeAILanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a = config.generateId) != null ? _a : chunk5YQHHVJF_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createJsonResponseHandler(responseSchema),
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = chunk5YQHHVJF_cjs.combineHeaders(
      await chunk5YQHHVJF_cjs.resolve(this.config.headers),
      options.headers
    );
    const { responseHeaders, value: response } = await chunk5YQHHVJF_cjs.postJsonToApi({
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createEventSourceResponseHandler(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
...
var responseSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var chunkSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      candidates: v4.z.array(
        v4.z.object({
...
var codeExecution = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var enterpriseWebSearch = chunk5YQHHVJF_cjs.createProviderDefinedToolFactory({
  id: "google.enterprise_web_search",
  name: "enterprise_web_search",
  inputSchema: chunk5YQHHVJF_cjs.lazySchema(() => chunk5YQHHVJF_cjs.zodSchema(v4.z.object({})))
});
...
var fileSearchArgsSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(fileSearchArgsBaseSchema)
);
var fileSearch = chunk5YQHHVJF_cjs.createProviderDefinedToolFactory({
  id: "google.file_search",
  name: "file_search",
  inputSchema: fileSearchArgsSchema
});
var googleMaps = chunk5YQHHVJF_cjs.createProviderDefinedToolFactory({
...
var googleSearchToolArgsSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(googleSearchToolArgsBaseSchema)
);
var googleSearch = chunk5YQHHVJF_cjs.createProviderDefinedToolFactory({
  id: "google.google_search",
  name: "google_search",
  inputSchema: googleSearchToolArgsSchema
});
var urlContext = chunk5YQHHVJF_cjs.createProviderDefinedToolFactory({
  id: "google.url_context",
  name: "url_context",
  inputSchema: chunk5YQHHVJF_cjs.lazySchema(() => chunk5YQHHVJF_cjs.zodSchema(v4.z.object({})))
});
var vertexRagStore = chunk5YQHHVJF_cjs.createProviderDefinedToolFactory({
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { responseHeaders, value: response } = await chunk5YQHHVJF_cjs.postJsonToApi({
      ...
      headers: chunk5YQHHVJF_cjs.combineHeaders(await chunk5YQHHVJF_cjs.resolve(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createJsonResponseHandler(
...
var googleImageResponseSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var googleImageProviderOptionsSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
function createGoogleGenerativeAI(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunk5YQHHVJF_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const providerName = (_b = options.name) != null ? _b : "google.generative-ai";
  const getHeaders = () => chunk5YQHHVJF_cjs.withUserAgentSuffix(
    {
      "x-goog-api-key": chunk5YQHHVJF_cjs.loadApiKey({
  ...
  const createChatModel = (modelId) => {
    ...
    return new GoogleGenerativeAILanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: (_a2 = options.generateId) != null ? _a2 : chunk5YQHHVJF_cjs.generateId,
      supportedUrls: () => ({
        "*": [
...
var openaiFailedResponseHandler = chunk5YQHHVJF_cjs.createJsonErrorResponseHandler({
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: {
                      url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunk5YQHHVJF_cjs.convertToBase64(part.data)}`,
                  ...
                  return {
                    ...
                    file: typeof part.data === "string" && part.data.startsWith("file-") ? { file_id: part.data } : {
                      ...
                      file_data: `data:application/pdf;base64,${chunk5YQHHVJF_cjs.convertToBase64(part.data)}`
                    }
                  };
                } else {
                  throw new chunk5YQHHVJF_cjs.UnsupportedFunctionalityError({
...
var openaiChatResponseSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
...
var openaiChatChunkSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiChatLanguageModelOptions = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a, _b, _c, _d;
    const warnings = [];
    const openaiOptions = (_a = await chunk5YQHHVJF_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    for (const toolCall of (_a = choice.message.tool_calls) != null ? _a : []) {
      content.push({
        type: "tool-call",
        toolCallId: (_b = toolCall.id) != null ? _b : chunk5YQHHVJF_cjs.generateId(),
    ...
    for (const annotation of (_c = choice.message.annotations) != null ? _c : []) {
      content.push({
        type: "source",
        sourceType: "url",
        id: chunk5YQHHVJF_cjs.generateId(),
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_o = toolCall2.function) == null ? void 0 : _o.name) != null && ((_p = toolCall2.function) == null ? void 0 : _p.arguments) != null) {
                    ...
                    if (chunk5YQHHVJF_cjs.isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_q = toolCall2.id) != null ? _q : chunk5YQHHVJF_cjs.generateId(),
                ...
                if (((_v = toolCall.function) == null ? void 0 : _v.name) != null && ((_w = toolCall.function) == null ? void 0 : _w.arguments) != null && chunk5YQHHVJF_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_x = toolCall.id) != null ? _x : chunk5YQHHVJF_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunk5YQHHVJF_cjs.InvalidPromptError({
...
var openaiCompletionResponseSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiCompletionChunkSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiCompletionProviderOptions = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAICompletionLanguageModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const openaiOptions = {
      ...await chunk5YQHHVJF_cjs.parseProviderOptions({
        provider: "openai",
        providerOptions,
...
var openaiEmbeddingProviderOptions = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      /**
...
var openaiTextEmbeddingResponseSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var openaiImageResponseSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      created: v4.z.number().nullish(),
      data: v4.z.array(
...
chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(baseImageModelOptionsObject)
);
var openaiImageModelGenerationOptions = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
...
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const currentDate = (_c = (_b = (_a = this.config._internal) == null ? void 0 : _a.currentDate) == null ? void 0 : _b.call(_a)) != null ? _c : /* @__PURE__ */ new Date();
    const openaiOptions = (_d = await chunk5YQHHVJF_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
...
var codeInterpreterInputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterOutputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      outputs: v4.z.array(
...
var codeInterpreterArgsSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterToolFactory = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var fileSearchArgsSchema2 = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var fileSearchOutputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var fileSearch2 = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.file_search",
  name: "file_search",
  inputSchema: v4.z.object({}),
  outputSchema: fileSearchOutputSchema
});
var imageGenerationArgsSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var imageGenerationInputSchema = chunk5YQHHVJF_cjs.lazySchema(() => chunk5YQHHVJF_cjs.zodSchema(v4.z.object({})));
var imageGenerationOutputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(v4.z.object({ result: v4.z.string() }))
);
var imageGenerationToolFactory = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var localShellInputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      action: v4.z.object({
...
var localShellOutputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(v4.z.object({ output: v4.z.string() }))
);
var localShell = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.local_shell",
  name: "local_shell",
  inputSchema: localShellInputSchema,
  outputSchema: localShellOutputSchema
});
var webSearchArgsSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var webSearchInputSchema = chunk5YQHHVJF_cjs.lazySchema(() => chunk5YQHHVJF_cjs.zodSchema(v4.z.object({})));
var webSearchOutputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var webSearchToolFactory = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var webSearchPreviewArgsSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      searchContextSize: v4.z.enum(["low", "medium", "high"]).optional(),
      userLocation: v4.z.object({
...
var webSearchPreviewInputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(v4.z.object({}))
);
var webSearchPreviewOutputSchema = chunk5YQHHVJF_cjs.lazySchema(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreview = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    ...part.data instanceof URL ? { image_url: part.data.toString() } : typeof part.data === "string" && isFileId(part.data, fileIdPrefixes) ? { file_id: part.data } : {
                      image_url: `data:${mediaType};base64,${chunk5YQHHVJF_cjs.convertToBase64(part.data)}`
                    },
          ...
          switch (part.type) {
            ...
            case "tool-call": {
              ...
              if (hasLocalShellTool && part.toolName === "local_shell") {
                const parsedInput = await chunk5YQHHVJF_cjs.validateTypes({
                  value: part.input,
            ...
            case "reasoning": {
              const providerOptions = await chunk5YQHHVJF_cjs.parseProviderOptions({
                provider: "openai",
      ...
      case "tool": {
        for (const part of content) {
          ...
          if (hasLocalShellTool && part.toolName === "local_shell" && output.type === "json") {
            const parsedOutput = await chunk5YQHHVJF_cjs.validateTypes({
              value: output.value,
...
var openaiResponsesChunkSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
      ...
      v4.z.object({
        ...
        response: v4.z.object({
          ...
          usage: v4.z.object({
            ...
            input_tokens_details: v4.z.object({
              cached_tokens: v4.z.number().nullish(),
              orchestration_input_tokens: v4.z.number().nullish(),
              orchestration_input_cached_tokens: v4.z.number().nullish()
            }).nullish(),
            output_tokens: v4.z.number(),
            output_tokens_details: v4.z.object({
              reasoning_tokens: v4.z.number().nullish(),
              orchestration_output_tokens: v4.z.number().nullish()
            }).nullish()
          }),
...
var openaiResponsesResponseSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
...
var openaiResponsesProviderOptionsSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      ...
      case "provider-defined": {
        switch (tool.id) {
          case "openai.file_search": {
            const args = await chunk5YQHHVJF_cjs.validateTypes({
              value: tool.args,
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    const openaiOptions = await chunk5YQHHVJF_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    if (response.error) {
      throw new chunk5YQHHVJF_cjs.APICallError({
            ...
            for (const annotation of contentPart.annotations) {
              if (annotation.type === "url_citation") {
                content.push({
                  type: "source",
                  sourceType: "url",
                  id: (_f = (_e = (_d = this.config).generateId) == null ? void 0 : _e.call(_d)) != null ? _f : chunk5YQHHVJF_cjs.generateId(),
                  url: annotation.url,
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_i = (_h = (_g = this.config).generateId) == null ? void 0 : _h.call(_g)) != null ? _i : chunk5YQHHVJF_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_o = (_n = (_m = this.config).generateId) == null ? void 0 : _n.call(_m)) != null ? _o : chunk5YQHHVJF_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = this.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunk5YQHHVJF_cjs.generateId(),
                  mediaType: "application/octet-stream",
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_r = (_q = (_p = self.config).generateId) == null ? void 0 : _q.call(_p)) != null ? _r : chunk5YQHHVJF_cjs.generateId(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = self.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunk5YQHHVJF_cjs.generateId(),
                  mediaType: "text/plain",
...
var openaiSpeechProviderOptionsSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      instructions: v4.z.string().nullish(),
...
var OpenAISpeechModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: requestBody,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunk5YQHHVJF_cjs.createBinaryResponseHandler(),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    return {
...
var openaiTranscriptionResponseSchema = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      text: v4.z.string(),
...
var openAITranscriptionProviderOptions = chunk5YQHHVJF_cjs.lazyValidator(
  () => chunk5YQHHVJF_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAITranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunk5YQHHVJF_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunk5YQHHVJF_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunk5YQHHVJF_cjs.postFormDataToApi({
      url: this.config.url({
...
var VERSION2 = "2.0.110" ;
function createOpenAI2(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunk5YQHHVJF_cjs.withoutTrailingSlash(
    chunk5YQHHVJF_cjs.loadOptionalSetting({
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.providerId === MASTRA_GATEWAY_ID) {
      ...
      this.providerModel = chunk5YQHHVJF_cjs.createOpenAICompatible({
        name: MASTRA_GATEWAY_ID,
        apiKey,
        baseURL: getMastraGatewayBaseUrl(normalizedConfig.url),
        headers: {
          "User-Agent": chunk5YQHHVJF_cjs.MASTRA_USER_AGENT,
      ...
      const registry = chunkLIS73MSY_cjs.GatewayRegistry.getInstance();
...
//# sourceMappingURL=chunk-OBB3OVBT.cjs.map
//# sourceMappingURL=chunk-OBB3OVBT.cjs.map