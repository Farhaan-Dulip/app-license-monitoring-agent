import { createJsonErrorResponseHandler2, lazySchema2, zodSchema2, lazySchema, zodSchema, createProviderToolFactory, createProviderToolFactoryWithOutputSchema, withoutTrailingSlash2, withoutTrailingSlash, OpenAICompatibleChatLanguageModel, generateId2, parseProviderOptions2, postJsonToApi2, createJsonResponseHandler2, combineHeaders2, createEventSourceResponseHandler2, InvalidResponseDataError2, withUserAgentSuffix2, loadApiKey2, withUserAgentSuffix, loadApiKey, createJsonErrorResponseHandler, parseProviderOptions, postJsonToApi, createJsonResponseHandler, combineHeaders, generateId, createEventSourceResponseHandler, InvalidResponseDataError, isParsableJson, injectJsonInstructionIntoMessages, APICallError2 as APICallError2$1, extractResponseHeaders, safeParseJSON, UnsupportedFunctionalityError2, UnsupportedFunctionalityError, convertToBase642, NoSuchModelError2, NoSuchModelError, OpenAICompatibleCompletionLanguageModel, OpenAICompatibleEmbeddingModel, MastraModelGateway, EXCLUDED_PROVIDERS, PROVIDERS_WITH_INSTALLED_PACKAGES, createOpenAI, MASTRA_USER_AGENT, createAnthropic, createGoogleGenerativeAI, createOpenAICompatible, TooManyEmbeddingValuesForCallError2, resolve2, AISDKError, delay, getFromApi, convertUint8ArrayToBase642, convertImageModelFileToDataUri, convertBase64ToUint8Array2, mediaTypeToExtension2, postFormDataToApi2, createBinaryResponseHandler2, createStatusCodeErrorResponseHandler, validateTypes2 as validateTypes2$1, convertUint8ArrayToBase64 } from './chunk-QD7SPEJN.js';
import { createGatewayProvider } from './chunk-HTACXXFO.js';
...
function fileToImageString(file) {
  ...
  return typeof file.data === "string" ? file.data : convertUint8ArrayToBase642(file.data);
}
...
function createAlibaba(options = {}) {
  ...
  const embeddingBaseURL = (_c = withoutTrailingSlash2(options.embeddingBaseURL)) != null ? _c : "https://dashscope-intl.aliyuncs.com/api/v1";
...
var chatCompletionsErrorSchema = z.object({
  error: z.object({
    message: z.string(),
    type: z.string().nullish(),
    param: z.any().nullish(),
...
//# sourceMappingURL=chunk-OLSGZFOG.js.map
//# sourceMappingURL=chunk-OLSGZFOG.js.map