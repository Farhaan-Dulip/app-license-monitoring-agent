  ...
  constructor({ id, disableInit }) {
    if (!id || typeof id !== "string" || id.trim() === "") {
      throw new chunkZWNRICII_cjs.MastraError({
        ...
        domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VECTOR,
...
function validateUpsertInput(storeName, vectors, metadata, ids) {
  if (!vectors || vectors.length === 0) {
    throw new chunkZWNRICII_cjs.MastraError({
      id: chunkXGNME7PA_cjs.createVectorErrorId(storeName, "UPSERT", "EMPTY_VECTORS"),
      domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkZWNRICII_cjs.ErrorCategory.USER,
      details: {
  ...
  if (metadata && metadata.length > 0 && metadata.length !== vectors.length) {
    throw new chunkZWNRICII_cjs.MastraError({
      id: chunkXGNME7PA_cjs.createVectorErrorId(storeName, "UPSERT", "METADATA_LENGTH_MISMATCH"),
      domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkZWNRICII_cjs.ErrorCategory.USER,
      details: {
  ...
  if (ids && ids.length !== vectors.length) {
    throw new chunkZWNRICII_cjs.MastraError({
      id: chunkXGNME7PA_cjs.createVectorErrorId(storeName, "UPSERT", "IDS_LENGTH_MISMATCH"),
      domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkZWNRICII_cjs.ErrorCategory.USER,
      details: {
...
function validateTopK(storeName, topK) {
  if (!Number.isInteger(topK) || topK <= 0) {
    throw new chunkZWNRICII_cjs.MastraError({
      id: chunkXGNME7PA_cjs.createVectorErrorId(storeName, "QUERY", "INVALID_TOP_K"),
      domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkZWNRICII_cjs.ErrorCategory.USER,
      details: {
...
function validateVectorValues(storeName, vectors) {
  for (let i = 0; i < vectors.length; i++) {
    ...
    if (!vector) {
      throw new chunkZWNRICII_cjs.MastraError({
        id: chunkXGNME7PA_cjs.createVectorErrorId(storeName, "UPSERT", "INVALID_VECTOR"),
        domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VECTOR,
        category: chunkZWNRICII_cjs.ErrorCategory.USER,
        details: {
    ...
    for (let j = 0; j < vector.length; j++) {
      ...
      if (value === null || value === void 0 || !Number.isFinite(value)) {
        throw new chunkZWNRICII_cjs.MastraError({
          id: chunkXGNME7PA_cjs.createVectorErrorId(storeName, "UPSERT", "INVALID_VECTOR_VALUE"),
          domain: chunkZWNRICII_cjs.ErrorDomain.MASTRA_VECTOR,
          category: chunkZWNRICII_cjs.ErrorCategory.USER,
          details: {
...
Object.defineProperty(exports, "embedV2", {
  enumerable: true,
  get: function () { return chunkHNRFQPHO_cjs.embed; }
});
Object.defineProperty(exports, "embedV3", {
  enumerable: true,
  get: function () { return chunk4MB5NE52_cjs.embed; }
});
Object.defineProperty(exports, "embedV1", {
  enumerable: true,
  get: function () { return chunkG4Y6R4NY_cjs.embed; }
});
