...
var unicodeNormalizerProvider = {
  ...
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.UnicodeNormalizer(config);
  }
};
var tokenLimiterProvider = {
  ...
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.TokenLimiterProcessor(
      config
    );
  }
};
var toolCallFilterProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.ToolCallFilter(config);
  }
};
var batchPartsProvider = {
  ...
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.BatchPartsProcessor(config);
  }
};
var moderationProvider = {
  ...
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.ModerationProcessor(config);
  }
};
var promptInjectionDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.PromptInjectionDetector(config);
  }
};
var piiDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.PIIDetector(config);
  }
};
var languageDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.LanguageDetector(config);
  }
};
var systemPromptScrubberProvider = {
  ...
  createProcessor(config) {
    return new chunk5R7YROFE_cjs.SystemPromptScrubber(config);
  }
};
