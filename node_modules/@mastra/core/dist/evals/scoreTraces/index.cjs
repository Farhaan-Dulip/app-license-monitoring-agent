...
var getTraceStep = chunk5R7YROFE_cjs.createStep2({
      ...
      const mastraError = new chunkZWNRICII_cjs.MastraError(
        {
          ...
          domain: chunkZWNRICII_cjs.ErrorDomain.SCORER,
          category: chunkZWNRICII_cjs.ErrorCategory.SYSTEM,
...
async function runScorerForTrace({
  ...
  return scorer.run({
    ...
    scoreSource: "trace",
    targetScope: "span",
    targetEntityType: chunkAHAX7NUG_cjs.getEntityTypeForSpan(span),
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkXMQFQRE2_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunk5R7YROFE_cjs.createWorkflow2({
