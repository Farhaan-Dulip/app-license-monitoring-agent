 ...
 */
export declare interface Agent<CALL_OPTIONS = never, TOOLS extends ToolSet = {}, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = never> {
    /**
 ...
 */
export declare type AgentCallParameters<CALL_OPTIONS, TOOLS extends ToolSet = {}, RUNTIME_CONTEXT extends Context = Context> = ([CALL_OPTIONS] extends [never] ? {
    options?: never;
} : {
 ...
 */
export declare type AgentStreamParameters<CALL_OPTIONS, TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context = Context> = AgentCallParameters<CALL_OPTIONS, TOOLS, RUNTIME_CONTEXT> & {
    /**
...
declare namespace _ai_sdk_provider {
    export {
        ...
        RealtimeModelV4 as Experimental_RealtimeModelV4,
        RealtimeModelV4AudioMessage as Experimental_RealtimeModelV4AudioMessage,
        RealtimeModelV4ClientEvent as Experimental_RealtimeModelV4ClientEvent,
        ...
        RealtimeModelV4ServerEvent as Experimental_RealtimeModelV4ServerEvent,
        RealtimeModelV4SessionConfig as Experimental_RealtimeModelV4SessionConfig,
        RealtimeModelV4TextMessage as Experimental_RealtimeModelV4TextMessage,
        RealtimeModelV4ToolDefinition as Experimental_RealtimeModelV4ToolDefinition,
        TranscriptionModelV4StreamOptions as Experimental_TranscriptionModelV4StreamOptions,
        TranscriptionModelV4StreamPart as Experimental_TranscriptionModelV4StreamPart,
        TranscriptionModelV4StreamResult as Experimental_TranscriptionModelV4StreamResult,
        ...
        VideoModelV4CallOptions as Experimental_VideoModelV4CallOptions,
        VideoModelV4File as Experimental_VideoModelV4File,
 ...
 */
export declare type AssistantContent = string | Array<TextPart | CustomPart | FilePart | ReasoningPart | ReasoningFilePart | ToolCallPart | ToolResultPart | ToolApprovalRequest>;
 ...
 */
export declare type CallWarning = SharedV4Warning;
 ...
 */
export declare function createAgentUIStreamResponse<CALL_OPTIONS = never, TOOLS extends ToolSet = {}, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = never, MESSAGE_METADATA = unknown>({ headers, status, statusText, consumeSseStream, ...options }: {
    agent: Agent<CALL_OPTIONS, TOOLS, RUNTIME_CONTEXT, OUTPUT>;
    uiMessages: unknown[];
    abortSignal?: AbortSignal;
    timeout?: TimeoutConfiguration<TOOLS>;
 ...
 */
export declare function createProviderRegistry<PROVIDERS extends Record<string, ProviderV4 | ProviderV3>, SEPARATOR extends string = ':'>(providers: PROVIDERS, { separator, languageModelMiddleware, imageModelMiddleware, }?: {
    separator?: SEPARATOR;
...
export declare function customProvider<LANGUAGE_MODELS extends Record<string, LanguageModel>, EMBEDDING_MODELS extends Record<string, EmbeddingModel>, IMAGE_MODELS extends Record<string, ImageModel>, TRANSCRIPTION_MODELS extends Record<string, TranscriptionModel>, SPEECH_MODELS extends Record<string, SpeechModel>, RERANKING_MODELS extends Record<string, RerankingModel>, VIDEO_MODELS extends Record<string, VideoModel>, FILES extends FilesV4 | undefined = undefined, SKILLS extends SkillsV4 | undefined = undefined, FALLBACK extends ProviderV2 | ProviderV3 | ProviderV4 | undefined = undefined>({ languageModels, embeddingModels, imageModels, transcriptionModels, speechModels, rerankingModels, videoModels, files, skills, fallbackProvider: fallbackProviderArg, }: {
    ...
    videoModel(modelId: ExtractModelId<VIDEO_MODELS>): VideoModelV4;
 ...
 * ```
 */
export declare class DirectChatTransport<CALL_OPTIONS = never, TOOLS extends ToolSet = {}, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = never, UI_MESSAGE extends UIMessage<unknown, never, InferUITools<TOOLS>> = UIMessage<unknown, never, InferUITools<TOOLS>>> implements ChatTransport<UI_MESSAGE> {
 ...
 */
export declare type DirectChatTransportOptions<CALL_OPTIONS, TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context, OUTPUT extends Output_2, UI_MESSAGE extends UIMessage<unknown, never, InferUITools<TOOLS>>> = {
    /**
 ...
 * Embedding.
 */
export declare type Embedding = EmbeddingModelV4Embedding;

/**
 * Embedding model that is used by the AI SDK.
 */
export declare type EmbeddingModel = string | EmbeddingModelV4 | EmbeddingModelV3 | EmbeddingModelV2<string>;
 ...
 */
declare type ExecutableTool<TOOL extends Tool = Tool> = TOOL & {
...
export declare type Experimental_RealtimeClientEvent = RealtimeModelV4ClientEvent;

export declare type Experimental_RealtimeFactory = RealtimeFactoryV4;

export declare type Experimental_RealtimeFactoryGetTokenOptions = RealtimeFactoryV4GetTokenOptions;

export declare type Experimental_RealtimeFactoryGetTokenResult = RealtimeFactoryV4GetTokenResult;

export declare type Experimental_RealtimeModel = RealtimeModelV4;

export declare type Experimental_RealtimeServerEvent = RealtimeModelV4ServerEvent;

export declare type Experimental_RealtimeSessionConfig = RealtimeModelV4SessionConfig;
...
export declare type Experimental_RealtimeToolDefinition = RealtimeModelV4ToolDefinition;
...
export declare type Experimental_SandboxSession = {
     ...
     */
    readonly spawn: (options: SandboxProcessOptions) => PromiseLike<Experimental_SandboxProcess>;
    /**
...
export declare interface FilePart {
     ...
     */
    data: FileData | DataContent | URL | ProviderReference_2;
    /**
 ...
 * completes.
 */
export declare type GenerateTextAbortEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = {
    /** Unique identifier for this generation call, used to correlate events. */
    readonly callId: string;
 ...
 */
export declare type GenerateTextEndEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = {
    /** Unique identifier for this generation call, used to correlate events. */
    readonly callId: string;
 ...
 */
export declare type GenerateTextOnAbortCallback<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = Callback<GenerateTextAbortEvent<TOOLS, RUNTIME_CONTEXT>>;
 ...
 */
export declare type GenerateTextOnEndCallback<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = Callback<GenerateTextEndEvent<TOOLS, RUNTIME_CONTEXT>>;
 ...
 */
export declare type GenerateTextOnFinishCallback<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = GenerateTextOnEndCallback<TOOLS, RUNTIME_CONTEXT>;
 ...
 */
export declare type GenerateTextOnStartCallback<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = Output_2> = Callback<GenerateTextStartEvent<TOOLS, RUNTIME_CONTEXT, OUTPUT>>;
 ...
 */
export declare type GenerateTextOnStepEndCallback<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = Callback<GenerateTextStepEndEvent<TOOLS, RUNTIME_CONTEXT>>;
 ...
 */
export declare type GenerateTextOnStepFinishCallback<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = GenerateTextOnStepEndCallback<TOOLS, RUNTIME_CONTEXT>;
 ...
 */
export declare type GenerateTextOnStepStartCallback<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = Output_2> = Callback<GenerateTextStepStartEvent<TOOLS, RUNTIME_CONTEXT, OUTPUT>>;

/**
 * The result of a `generateText` call.
 * It contains the generated text, the tool calls that were made during the generation, and the results of the tool calls.
 */
export declare interface GenerateTextResult<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context, OUTPUT extends Output_2> {
    /**
     * The content that was generated in all steps.
     */
 ...
 */
export declare type GenerateTextStartEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = Output_2> = {
    /** Unique identifier for this generation call, used to correlate events. */
    readonly callId: string;
 ...
 */
export declare type GenerateTextStepEndEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = StepResult<TOOLS, RUNTIME_CONTEXT>;
 ...
 */
export declare type GenerateTextStepStartEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = Output_2> = {
    /** Unique identifier for this generation call, used to correlate events. */
    readonly callId: string;
    /** The provider identifier (e.g., 'openai', 'anthropic'). */
    readonly provider: string;
 ...
 */
export declare type GenericToolApprovalFunction<TOOLS extends ToolSet, TOOLS_CONTEXT extends InferToolSetContext<TOOLS>, RUNTIME_CONTEXT extends Context | unknown | never> = (options: {
    /**
 ...
 */
export declare type ImageModel = string | ImageModelV4 | ImageModelV3 | ImageModelV2;
 ...
 */
export declare type ImageModelProviderMetadata = ImageModelV4ProviderMetadata | ImageModelV2ProviderMetadata;
 ...
 */
export declare type ImageModelUsage = ImageModelV4Usage;
...
export declare interface ImagePart {
     ...
     */
    image: DataContent | URL | ProviderReference_2;
    /**
...
declare type IncludedContext<CONTEXT extends Context | unknown | never> = {
 ...
 */
declare type InferToolContext<TOOL extends Tool> = TOOL extends Tool<any, any, infer CONTEXT> ? IsUntypedContext<CONTEXT> extends true ? never : CONTEXT : never;
 ...
 */
declare type InferToolSetContext<TOOLS extends ToolSet> = Normalize<RequiredToolSetContext<TOOLS> & OptionalToolSetContext<TOOLS>>;
...
declare type InlineFileData = Extract<FilePart['data'], {
    type: 'data';
} | {
    type: 'text';
}>;
 ...
 */
declare type IsEmptyObject_2<OBJECT> = keyof OBJECT extends never ? true : false;
 ...
 */
export declare type LanguageModel = GlobalProviderModelId | LanguageModelV4 | LanguageModelV3 | LanguageModelV2;
...
export declare type OnFinishEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = GenerateTextEndEvent<TOOLS, RUNTIME_CONTEXT>;
...
export declare type OnStartEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = Output_2> = GenerateTextStartEvent<TOOLS, RUNTIME_CONTEXT, OUTPUT>;

/** @deprecated Use `GenerateTextStepEndEvent` instead. */
export declare type OnStepFinishEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = GenerateTextStepEndEvent<TOOLS, RUNTIME_CONTEXT>;

/** @deprecated Use `GenerateTextStepStartEvent` instead. */
export declare type OnStepStartEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = Output_2> = GenerateTextStepStartEvent<TOOLS, RUNTIME_CONTEXT, OUTPUT>;
 ...
 */
declare type OptionalToolSetContext<TOOLS extends ToolSet> = {
 ...
 * @param consumeSseStream - Whether to consume the SSE stream. Optional.
 */
export declare function pipeAgentUIStreamToResponse<CALL_OPTIONS = never, TOOLS extends ToolSet = {}, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = never, MESSAGE_METADATA = unknown>({ response, headers, status, statusText, consumeSseStream, ...options }: {
 ...
 */
export declare type PrepareStepFunction<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context = Context> = (options: {
    /**
 ...
 */
export declare type PrepareStepResult<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context = Context> = {
    /**
 ...
 */
export declare type ProviderMetadata = SharedV4ProviderMetadata;
 ...
 */
declare type ProviderReference_2 = SharedV4ProviderReference;

export declare interface ProviderRegistryProvider<PROVIDERS extends Record<string, ProviderV4 | ProviderV3> = Record<string, ProviderV4 | ProviderV3>, SEPARATOR extends string = ':'> {
    ...
    videoModel<KEY extends keyof PROVIDERS>(id: KEY extends string ? `${KEY & string}${SEPARATOR}${ProviderVideoModelIdentifier<PROVIDERS[KEY]>}` : never): VideoModelV4;
    videoModel<KEY extends keyof PROVIDERS>(id: KEY extends string ? `${KEY & string}${SEPARATOR}${string}` : never): VideoModelV4;
 ...
 */
declare type RequiredToolSetContext<TOOLS extends ToolSet> = {
 ...
 */
export declare function rerank<VALUE extends JSONObject | string>({ model: modelArg, documents, query, topN, maxRetries: maxRetriesArg, abortSignal, headers, providerOptions, experimental_telemetry, telemetry, onStart, experimental_onStart, onEnd, experimental_onEnd, _internal: { generateCallId }, }: {
    /**
 ...
 */
export declare type RerankingModel = string | RerankingModelV4 | RerankingModelV3;
 ...
 * Return `undefined` for the same effect as the `not-applicable` status.
 */
export declare type SingleToolApprovalFunction<INPUT, TOOL_CONTEXT extends Context | unknown | never, RUNTIME_CONTEXT extends Context | unknown | never> = (input: INPUT, options: Omit<ToolExecutionOptions<TOOL_CONTEXT>, 'abortSignal' | 'context'> & {
 ...
 * A source that has been used as input to generate the response.
 */
declare type Source = LanguageModelV4Source;
 ...
 */
export declare type SpeechModel = string | SpeechModelV4 | SpeechModelV3 | SpeechModelV2;
 ...
 */
export declare type StepResult<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context = Context> = {
    /**
 ...
 */
export declare type StopCondition<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context = Context> = (options: {
 ...
 * @param event - The event that is passed to the callback.
 */
declare type StreamTextOnAbortCallback<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context> = Callback<{
    /**
     * Details for all previously finished steps.
     */
    readonly steps: StepResult<TOOLS, RUNTIME_CONTEXT>[];
 ...
 * A result object for accessing different stream types and additional information.
 */
export declare interface StreamTextResult<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context, OUTPUT extends Output_2> {
    /**
     * The content that was generated in all steps.
     *
 ...
 */
export declare type TelemetryOptions<RUNTIME_CONTEXT extends Context = Context, TOOLS extends ToolSet = ToolSet> = {
    /**
...
export declare type TelemetryTracingEventType = 'generateText' | 'streamText' | 'step' | 'languageModelCall' | 'executeTool' | 'embed' | 'rerank';
 ...
 * the AI SDK.
 */
export declare type Tool<INPUT extends JSONValue_2 | unknown | never = any, OUTPUT extends JSONValue_2 | unknown | never = any, CONTEXT extends Context | unknown | never = any> = FunctionTool<INPUT, OUTPUT, CONTEXT> | DynamicTool<INPUT, OUTPUT, CONTEXT> | ProviderDefinedTool<INPUT, OUTPUT, CONTEXT> | ProviderExecutedTool<INPUT, OUTPUT, CONTEXT>;
 ...
 */
export declare function tool<INPUT, OUTPUT, CONTEXT extends Context>(tool: Tool<INPUT, OUTPUT, CONTEXT> & {
    execute: ToolExecuteFunction<INPUT, OUTPUT, CONTEXT>;
}): ExecutableTool<Tool<INPUT, OUTPUT, CONTEXT>>;

export declare function tool<INPUT, OUTPUT, CONTEXT extends Context>(tool: Tool<INPUT, OUTPUT, CONTEXT>): Tool<INPUT, OUTPUT, CONTEXT>;

export declare function tool<INPUT, CONTEXT extends Context>(tool: Tool<INPUT, never, CONTEXT>): Tool<INPUT, never, CONTEXT>;

export declare function tool<OUTPUT, CONTEXT extends Context>(tool: Tool<never, OUTPUT, CONTEXT>): Tool<never, OUTPUT, CONTEXT>;

export declare function tool<CONTEXT extends Context>(tool: Tool<never, never, CONTEXT>): Tool<never, never, CONTEXT>;
 ...
 */
export declare type ToolApprovalConfiguration<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context | unknown | never> = GenericToolApprovalFunction<TOOLS, InferToolSetContext<TOOLS>, RUNTIME_CONTEXT> | {
 ...
 */
export declare type ToolExecuteFunction<INPUT, OUTPUT, CONTEXT extends Context | unknown | never> = (input: INPUT, options: ToolExecutionOptions<CONTEXT>) => AsyncIterable<OUTPUT> | PromiseLike<OUTPUT> | OUTPUT;
 ...
 */
export declare interface ToolExecutionOptions<CONTEXT extends Context | unknown | never> {
    /**
     * The ID of the tool call. You can use it e.g. when sending tool-call related information with stream data.
     */
    toolCallId: string;
 ...
 */
declare class ToolLoopAgent<CALL_OPTIONS = never, TOOLS extends ToolSet = {}, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = never> implements Agent<CALL_OPTIONS, TOOLS, RUNTIME_CONTEXT, OUTPUT> {
    readonly version = "agent-v1";
 ...
 */
declare type ToolLoopAgentSettings<CALL_OPTIONS = never, TOOLS extends ToolSet = {}, RUNTIME_CONTEXT extends Context = Context, OUTPUT extends Output_2 = never> = LanguageModelCallOptions & Omit<RequestOptions<TOOLS>, 'abortSignal'> & ToolsContextParameter<TOOLS> & {
    /**
     * The id of the agent.
     */
    id?: string;
...
declare type ToolsContextParameter<TOOLS extends ToolSet> = {
    tools?: TOOLS;
} & (IsEmptyObject_2<InferToolSetContext<TOOLS>> extends true ? {
    toolsContext?: never;
 ...
 */
export declare type TranscriptionModel = string | TranscriptionModelV4 | TranscriptionModelV3 | TranscriptionModelV2;
...
declare type UploadSkillFile = Omit<SkillsV4File, 'data'> & {
    /**
     * The file data. Accepts the tagged `{ type: 'data' | 'text' }` shapes, or
     * the shorthand `Uint8Array | string` (treated as `{ type: 'data', data }`).
     */
...
export declare type UploadSkillResult = Omit<SkillsV4UploadSkillResult, 'providerReference' | 'warnings'> & {
    readonly providerReference: ProviderReference;
 ...
 */
declare type VideoModel = string | VideoModelV4 | VideoModelV3;

declare type VideoModelProviderMetadata = SharedV4ProviderMetadata;
 ...
 * some settings might not be supported, which can lead to suboptimal results.
 */
export declare type Warning = SharedV4Warning;
...
export { }
export { GatewayProviderSettings as GatewayProviderSettings, GatewayProvider as GatewayProvider, FileData as FileData, ProviderReference_2 as ProviderReference_2, ToolResultOutput as ToolResultOutput, LazySchema as LazySchema, ZodSchema as ZodSchema, StandardSchema as StandardSchema, ValidationResult as ValidationResult, ParseResult as ParseResult, ProviderOptions as ProviderOptions, CustomPart as CustomPart, ReasoningPart as ReasoningPart, ReasoningFilePart as ReasoningFilePart, ReadFileOptions as ReadFileOptions, WriteFileOptions as WriteFileOptions, SandboxProcessOptions as SandboxProcessOptions, FunctionTool as FunctionTool, ProviderDefinedTool as ProviderDefinedTool, ProviderExecutedTool as ProviderExecutedTool, ExecutableTool as ExecutableTool, DynamicTool as DynamicTool, SharedV4ProviderReference as SharedV4ProviderReference, TypeValidationContext as TypeValidationContext, EmbeddingModelV3 as EmbeddingModelV3, EmbeddingModelV2 as EmbeddingModelV2, EmbeddingModelV4Embedding as EmbeddingModelV4Embedding, EmbeddingModelV4Middleware as EmbeddingModelV4Middleware, ImageModelV3 as ImageModelV3, ImageModelV2 as ImageModelV2, ImageModelV4ProviderMetadata as ImageModelV4ProviderMetadata, ImageModelV2ProviderMetadata as ImageModelV2ProviderMetadata, ImageModelV4Middleware as ImageModelV4Middleware, GlobalProviderModelId as GlobalProviderModelId, LanguageModelV3 as LanguageModelV3, LanguageModelV2 as LanguageModelV2, SharedV4Warning as SharedV4Warning, LanguageModelV4Middleware as LanguageModelV4Middleware, RerankingModelV3 as RerankingModelV3, SharedV4ProviderMetadata as SharedV4ProviderMetadata, SpeechModelV3 as SpeechModelV3, SpeechModelV2 as SpeechModelV2, TranscriptionModelV3 as TranscriptionModelV3, TranscriptionModelV2 as TranscriptionModelV2, ImageModelV4Usage as ImageModelV4Usage, DeepPartialInternal as DeepPartialInternal, IncludedContext as IncludedContext, IncludedToolsContext as IncludedToolsContext, BaseToolCall as BaseToolCall, Source as Source, ValueOf as ValueOf, asUITool as asUITool, _ai_sdk_provider_utils as _ai_sdk_provider_utils, _ai_sdk_provider as _ai_sdk_provider, DataUIMessageChunk as DataUIMessageChunk, InferElementOutput as InferElementOutput, ConsumeStreamOptions as ConsumeStreamOptions, TextStreamTextStartPart as TextStreamTextStartPart, TextStreamTextEndPart as TextStreamTextEndPart, TextStreamReasoningStartPart as TextStreamReasoningStartPart, TextStreamReasoningEndPart as TextStreamReasoningEndPart, TextStreamCustomPart as TextStreamCustomPart, TextStreamToolInputStartPart as TextStreamToolInputStartPart, TextStreamToolInputEndPart as TextStreamToolInputEndPart, TextStreamToolInputDeltaPart as TextStreamToolInputDeltaPart, TextStreamSourcePart as TextStreamSourcePart, TextStreamToolOutputDeniedPart as TextStreamToolOutputDeniedPart, TextStreamStartStepPart as TextStreamStartStepPart, TextStreamFinishStepPart as TextStreamFinishStepPart, TextStreamStartPart as TextStreamStartPart, TextStreamFinishPart as TextStreamFinishPart, TextStreamAbortPart as TextStreamAbortPart, TextStreamErrorPart as TextStreamErrorPart, TextStreamRawPart as TextStreamRawPart, MaybePromiseLike as MaybePromiseLike, InferToolContext as InferToolContext, LanguageModelV4ToolCall as LanguageModelV4ToolCall, WidenedToolExecutionStartEvent as WidenedToolExecutionStartEvent, StaticToolExecutionStartEvent as StaticToolExecutionStartEvent, DynamicToolExecutionStartEvent as DynamicToolExecutionStartEvent, WidenedToolExecutionEndEvent as WidenedToolExecutionEndEvent, StaticToolExecutionEndEvent as StaticToolExecutionEndEvent, DynamicToolExecutionEndEvent as DynamicToolExecutionEndEvent, StreamTextOnAbortCallback as StreamTextOnAbortCallback, StandardizedPrompt as StandardizedPrompt, ResponseMessage as ResponseMessage, OperationStartEvent as OperationStartEvent, OperationEndEvent as OperationEndEvent, Arrayable as Arrayable, Context as Context, Output_2 as Output_2, ToolsContextParameter as ToolsContextParameter, InferAgentTools as InferAgentTools, UIMessageStreamResponseInit as UIMessageStreamResponseInit, getOriginalFetch as getOriginalFetch, InferUIMessageTools as InferUIMessageTools, InferUIMessageToolCall as InferUIMessageToolCall, UIDataTypesToSchemas as UIDataTypesToSchemas, InferUIMessageData as InferUIMessageData, InferUIMessageMetadata as InferUIMessageMetadata, Resolvable as Resolvable, FetchFunction as FetchFunction, Callback as Callback, TextStreamTextDeltaPart as TextStreamTextDeltaPart, TextStreamReasoningDeltaPart as TextStreamReasoningDeltaPart, TextStreamFilePart as TextStreamFilePart, TextStreamReasoningFilePart as TextStreamReasoningFilePart, TextStreamToolApprovalRequestPart as TextStreamToolApprovalRequestPart, TextStreamToolApprovalResponsePart as TextStreamToolApprovalResponsePart, TextStreamToolCallPart as TextStreamToolCallPart, TextStreamToolResultPart as TextStreamToolResultPart, TextStreamToolErrorPart as TextStreamToolErrorPart, LanguageModelV4Prompt as LanguageModelV4Prompt, SharedV4Headers as SharedV4Headers, RetryErrorReason_2 as RetryErrorReason_2, ActiveToolSubset as ActiveToolSubset, GenerateImagePrompt as GenerateImagePrompt, JSONValue_2 as JSONValue_2, Job as Job, StreamObjectOnErrorCallback as StreamObjectOnErrorCallback, VideoModelResponseMetadata as VideoModelResponseMetadata, VideoModelProviderMetadata as VideoModelProviderMetadata, VideoModelV4FrameType as VideoModelV4FrameType, EmbeddingModelV4CallOptions as EmbeddingModelV4CallOptions, LanguageModelV4CallOptions as LanguageModelV4CallOptions, JSONObject as JSONObject, RealtimeFactoryV4 as RealtimeFactoryV4, RealtimeFactoryV4GetTokenOptions as RealtimeFactoryV4GetTokenOptions, RealtimeFactoryV4GetTokenResult as RealtimeFactoryV4GetTokenResult, RealtimeModelV4 as RealtimeModelV4, RealtimeModelV4ClientEvent as RealtimeModelV4ClientEvent, RealtimeModelV4ServerEvent as RealtimeModelV4ServerEvent, RealtimeModelV4SessionConfig as RealtimeModelV4SessionConfig, RealtimeModelV4ToolDefinition as RealtimeModelV4ToolDefinition, InferToolSetContext as InferToolSetContext, VideoModel as VideoModel, FilesV4 as FilesV4, SkillsV4 as SkillsV4, ProviderV2 as ProviderV2, ExtractModelId as ExtractModelId, LanguageModelV4 as LanguageModelV4, EmbeddingModelV4 as EmbeddingModelV4, ImageModelV4 as ImageModelV4, TranscriptionModelV4 as TranscriptionModelV4, RerankingModelV4 as RerankingModelV4, SpeechModelV4 as SpeechModelV4, VideoModelV4 as VideoModelV4, ExtractLiteralUnion as ExtractLiteralUnion, ProviderVideoModelIdentifier as ProviderVideoModelIdentifier, ProviderV4 as ProviderV4, ProviderV3 as ProviderV3, FilesV4UploadFileCallOptions as FilesV4UploadFileCallOptions, SkillsV4UploadSkillResult as SkillsV4UploadSkillResult, SkillsV4UploadSkillCallOptions as SkillsV4UploadSkillCallOptions, UploadSkillFile as UploadSkillFile };
export { schemaSymbol, symbol$1, symbol$1_2, symbol$2, symbol$2_2, symbol$3, symbol$3_2, symbol$4, symbol$4_2, symbol$5, symbol$5_2, symbol$6, symbol$6_2, symbol$7, symbol$7_2, symbol$8, symbol$8_2, symbol$9, symbol$9_2, symbol$a, symbol$a_2, symbol$b, symbol$b_2, symbol$c, symbol$c_2, symbol$d, symbol$d_2, symbol$e, symbol$e_2, symbol$f, symbol$g, symbol$h, symbol$i, symbol$j, symbol$k, symbol, symbol_2, symbol_3 };
