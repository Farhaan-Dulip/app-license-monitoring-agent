        ...
        if (!context) {
          ...
          if (isAgentExecution && !baseContext.agent) {
            ...
            organizedContext = {
              ...
              requestContext: rest.requestContext || new chunkD2FOXUYM_cjs.RequestContext()
            };
            ...
            organizedContext = {
              ...
              requestContext: baseContext.requestContext || new chunkD2FOXUYM_cjs.RequestContext()
            };
          }
        }
...
//# sourceMappingURL=chunk-MNNNQBVN.cjs.map
//# sourceMappingURL=chunk-MNNNQBVN.cjs.map