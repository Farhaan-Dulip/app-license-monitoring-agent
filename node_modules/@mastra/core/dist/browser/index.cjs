...
2. Remove profile/executablePath to connect to the existing browser via CDP`
  ...
  getInputProcessors(configuredProcessors = []) {
    const hasProcessor = configuredProcessors.some(
      (p) => !chunkE7BWKNX2_cjs.isProcessorWorkflow(p) && "id" in p && p.id === "browser-context"
    );
...
function createBrowserRecordingTools(browser, options) {
  ...
  return {
    browser_record: chunkMNNNQBVN_cjs.createTool({
      id: "browser_record",
    ...
    browser_record_caption: chunkMNNNQBVN_cjs.createTool({
...
Object.defineProperty(exports, "BrowserCliHandler", {
  enumerable: true,
  get: function () { return chunk5R7YROFE_cjs.BrowserCliHandler; }
});
Object.defineProperty(exports, "browserCliHandler", {
  enumerable: true,
  get: function () { return chunk5R7YROFE_cjs.browserCliHandler; }
