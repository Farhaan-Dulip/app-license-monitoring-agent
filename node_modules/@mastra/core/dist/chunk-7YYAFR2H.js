import { parseMemoryRequestContext, getStateSignalsMetadata, resolveStateSignalHistory, applyStateSignal } from './chunk-RW4W77ZV.js';
import { attachModelStreamTransport, readModelStreamTransport, resolveModelConfig } from './chunk-5RBSQIBI.js';
import { isStandardSchemaWithJSON, standardSchemaToJSONSchema, toStandardSchema } from './chunk-6SRTDZ7S.js';
import { resolveObservabilityContext, createObservabilityContext } from './chunk-TJLLOCZN.js';
import { getRootExportSpan, EntityType } from './chunk-GXMRXZKZ.js';
import { MastraBase } from './chunk-77VL4DNS.js';
import { coreContentToString, createSignal, MessageList, messagesAreEqual } from './chunk-DW27UJIQ.js';
import { NoObjectGeneratedError, parsePartialJson, isDeepEqualData } from './chunk-UANX6EXY.js';
import { JSONParseError, TypeValidationError } from './chunk-UAMXGTAY.js';
import { getErrorFromUnknown, MastraError, ErrorCategory, ErrorDomain } from './chunk-HJNLTRHA.js';
...
function isStructuredOutputFormatError(error) {
  return JSONParseError.isInstance(error) || NoObjectGeneratedError.isInstance(error) || TypeValidationError.isInstance(error) || error instanceof MastraError && error.id === "STRUCTURED_OUTPUT_OBJECT_UNDEFINED";
}
...
//# sourceMappingURL=chunk-7YYAFR2H.js.map
//# sourceMappingURL=chunk-7YYAFR2H.js.map