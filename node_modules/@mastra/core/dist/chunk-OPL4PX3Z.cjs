...
var ScorerDefinitionsStorage = class extends chunkFJFMJDFF_cjs.VersionedStorageDomain {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      scorers = scorers.filter((scorer) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkHEE7C2GC_cjs.deepEqual(scorer.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-OPL4PX3Z.cjs.map
//# sourceMappingURL=chunk-OPL4PX3Z.cjs.map