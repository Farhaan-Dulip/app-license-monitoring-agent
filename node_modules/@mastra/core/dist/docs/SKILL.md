...
- [Discord](references/docs-capabilities-channels-discord.md) - Configure a Mastra agent to receive Discord interactions and messages through a channel adapter.
- [More](references/docs-capabilities-channels-other-adapters.md) - Use other Chat SDK adapters with Mastra channels.
- [Channels overview](references/docs-capabilities-channels-overview.md) - Channels connect Mastra agents to messaging platforms like Slack, Discord, and Telegram.
- [Slack](references/docs-capabilities-channels-slack.md) - Configure a Mastra agent to respond in Slack channels and direct messages through a channel adapter.
- [Microsoft Teams](references/docs-capabilities-channels-teams.md) - Configure a Mastra agent to receive Microsoft Teams messages and mentions through a channel adapter.
- [Telegram](references/docs-capabilities-channels-telegram.md) - Configure a Mastra agent to receive Telegram messages through a channel adapter.
- [WhatsApp](references/docs-capabilities-channels-whatsapp.md) - Configure a Mastra agent to receive WhatsApp Business Cloud messages through a channel adapter.
...
- [File-based agents](references/docs-getting-started-file-based-agents.md) - Define agents and project primitives by file convention under src/mastra
...
- [Instructions](references/reference-file-based-agents-instructions.md) - Write a file-based agent's always-on system prompt with instructions.md, and learn when to reach for tools or skills instead.
...
- [Skills](references/reference-file-based-agents-skills.md) - Add skills to a file-based agent under skills/ using modules, packaged SKILL.md, or flat markdown.
