...
var MastraLLMV1 = class extends chunkWSD4JNMB_cjs.MastraBase {
  ...
  async __text({
    ...
    if (experimental_output) {
      ...
      if (chunkHEE7C2GC_cjs.isZodType(experimental_output)) {
    ...
    const argsForExecute = {
      ...
      onStepFinish: async (props) => {
        ...
        if (!isNaN(remainingTokens) && remainingTokens > 0 && remainingTokens < 2e3) {
          ...
          await chunkHEE7C2GC_cjs.delay(10 * 1e3);
          rateLimitSpan?.end();
        }
      },
      experimental_output: schema ? chunkG4Y6R4NY_cjs.output_exports.object({
        schema
      }) : void 0
    };
    try {
      const result = await chunkAHAX7NUG_cjs.executeWithContext({
        span: llmSpan,
        fn: () => chunkG4Y6R4NY_cjs.generateText(argsForExecute)
      });
      ...
      const mastraError = new chunkZWNRICII_cjs.MastraError(
        {
          ...
          domain: chunkZWNRICII_cjs.ErrorDomain.LLM,
          category: chunkZWNRICII_cjs.ErrorCategory.THIRD_PARTY,
          details: {
            modelId: model.modelId,
            modelProvider: model.provider,
            runId: runId ?? "unknown",
  ...
  async __textObject({
    ...
    try {
      ...
      try {
        const result = await chunkG4Y6R4NY_cjs.generateObject(argsForExecute);
        llmSpan?.end({
          output: {
            object: result.object,
            warnings: result.warnings
      ...
      if (e instanceof chunkZWNRICII_cjs.MastraError) {
        throw e;
      }
      const mastraError = new chunkZWNRICII_cjs.MastraError(
        {
  ...
  __stream({
    ...
    if (llmSpan) {
      chunkAHAX7NUG_cjs.executeWithContextSync({
        span: llmSpan,
    ...
    try {
      return chunkAHAX7NUG_cjs.executeWithContextSync({ span: llmSpan, fn: () => chunkG4Y6R4NY_cjs.streamText(argsForExecute) });
    } catch (e) {
      const mastraError = new chunkZWNRICII_cjs.MastraError(
        {
  ...
  __streamObject({
    ...
    try {
      ...
      try {
        return chunkG4Y6R4NY_cjs.streamObject(argsForExecute);
      } catch (e) {
        const mastraError = new chunkZWNRICII_cjs.MastraError(
          {
...
//# sourceMappingURL=chunk-VJIIR3YT.cjs.map
//# sourceMappingURL=chunk-VJIIR3YT.cjs.map