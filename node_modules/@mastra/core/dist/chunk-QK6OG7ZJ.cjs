...
var chunk5PDT2BPO_cjs = require('./chunk-5PDT2BPO.cjs');
var chunkO5UD5NQL_cjs = require('./chunk-O5UD5NQL.cjs');
...
chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var fileSearch = chunk5YQHHVJF_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var DeepSeekChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a, _b;
    const deepseekOptions = (_a = await chunk5YQHHVJF_cjs.parseProviderOptions({
      provider: this.providerOptionsName,
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a = toolCall.id) != null ? _a : chunk5YQHHVJF_cjs.generateId(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/azure/2.0.114/61a810ef664aa3394df48e328564bc50751e924ee14942fbe2153fc7665126ae/node_modules/@ai-sdk/azure/dist/index.mjs
...
function createAzure(options = {}) {
  ...
  if (options.apiKey && tokenProvider) {
    throw new chunk5YQHHVJF_cjs.InvalidArgumentError({
  ...
  const getHeaders = () => {
    const authHeaders = tokenProvider ? {} : {
      "api-key": chunk5YQHHVJF_cjs.loadApiKey({
  ...
  const fetch2 = tokenProvider ? async (input, init) => {
    var _a2;
    const headers = chunk5YQHHVJF_cjs.normalizeHeaders(init == null ? void 0 : init.headers);
  ...
  const getResourceName = () => chunk5YQHHVJF_cjs.loadSetting({
...
var AzureOpenAIGateway = class extends chunk5YQHHVJF_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
    this.validateConfig();
  ...
  async resolveLanguageModel({
    ...
    const azureConfig = {
      ...
      headers: { "User-Agent": chunk5YQHHVJF_cjs.MASTRA_USER_AGENT, ...headers },
    ...
    if (useResponsesAPI) {
      ...
      if (websocketFetch) {
        Object.defineProperty(model, chunk5YQHHVJF_cjs.MASTRA_GATEWAY_STREAM_TRANSPORT, {
          configurable: true,
          value: {
...
function isExpectedMissingAuthError(error) {
  if (error instanceof chunkZWNRICII_cjs.MastraError) {
...
var GatewayManager = class _GatewayManager {
  ...
  constructor(gateways = []) {
    ...
    this.gateways = gateways.filter((gateway) => {
      if (!chunkLIS73MSY_cjs.shouldEnableGateway(gateway)) return false;
      const id = chunkLIS73MSY_cjs.getGatewayId(gateway);
  ...
  findGatewayForModel(routerId) {
    return chunkLIS73MSY_cjs.findGatewayForModel(routerId, this.gateways);
  }
  /**
  ...
  resolveModelId(routerId) {
    ...
    const gatewayId = chunkLIS73MSY_cjs.getGatewayId(gateway);
    const { providerId, modelId } = chunkO5UD5NQL_cjs.parseModelRouterId(routerId, _GatewayManager.getPrefixForId(gatewayId, routerId));
    ...
    for (const gateway of this.gateways) {
      try {
        ...
        for (const [providerId, config] of Object.entries(gatewayProviders)) {
          ...
          registry[key] = { ...config, gateway: chunkLIS73MSY_cjs.getGatewayId(gateway) };
        }
      } catch (error) {
        console.warn(`Failed to load providers from gateway ${chunkLIS73MSY_cjs.getGatewayId(gateway)}:`, error);
      }
    }
    return registry;
  }
...
function getStaticProvidersByGateway(name) {
  return Object.fromEntries(Object.entries(chunkLIS73MSY_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name));
}
var defaultGateways = [
  new chunk5PDT2BPO_cjs.NetlifyGateway(),
  new chunkLIS73MSY_cjs.MastraGateway(),
  new chunkO5UD5NQL_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))
];
...
//# sourceMappingURL=chunk-QK6OG7ZJ.cjs.map
//# sourceMappingURL=chunk-QK6OG7ZJ.cjs.map