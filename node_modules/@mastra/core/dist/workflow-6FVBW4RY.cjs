...
function buildBackgroundTaskWorkflow(manager) {
  const runAttemptStep = chunk5R7YROFE_cjs.createStep2({
    id: "run-attempt",
  ...
  const classifyOutcomeStep = chunk5R7YROFE_cjs.createStep2({
    id: "classify-outcome",
  ...
  const attemptBodyWorkflow = chunk5R7YROFE_cjs.createWorkflow2({
    id: `${chunkH4SAIERM_cjs.BACKGROUND_TASK_WORKFLOW_ID}__attempt`,
    inputSchema: bodyIOSchema,
    outputSchema: bodyOutputSchema,
  ...
  return chunk5R7YROFE_cjs.createWorkflow2({
    id: chunkH4SAIERM_cjs.BACKGROUND_TASK_WORKFLOW_ID,
    inputSchema,
    outputSchema: bodyOutputSchema,
...
Object.defineProperty(exports, "BACKGROUND_TASK_WORKFLOW_ID", {
  enumerable: true,
  get: function () { return chunkH4SAIERM_cjs.BACKGROUND_TASK_WORKFLOW_ID; }
});
exports.buildBackgroundTaskWorkflow = buildBackgroundTaskWorkflow;
//# sourceMappingURL=workflow-6FVBW4RY.cjs.map
//# sourceMappingURL=workflow-6FVBW4RY.cjs.map