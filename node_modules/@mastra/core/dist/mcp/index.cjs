    ...
    if (this.originalTools && typeof this.originalTools === "object") {
      Object.entries(this.originalTools).forEach(([key, tool]) => {
        try {
          ...
          if (!(error instanceof chunkZWNRICII_cjs.MastraError) || error.id !== "MASTRA_ADD_TOOL_DUPLICATE_KEY") {
            throw error;
          }
        }
      });
    ...
    if (this.agents && typeof this.agents === "object") {
      Object.entries(this.agents).forEach(([key, agent]) => {
        try {
          ...
          if (!(error instanceof chunkZWNRICII_cjs.MastraError) || error.id !== "MASTRA_ADD_AGENT_DUPLICATE_KEY") {
            throw error;
          }
        }
      });
    ...
    if (this.workflows && typeof this.workflows === "object") {
      Object.entries(this.workflows).forEach(([key, workflow]) => {
        try {
          ...
          if (!(error instanceof chunkZWNRICII_cjs.MastraError) || error.id !== "MASTRA_ADD_WORKFLOW_DUPLICATE_KEY") {
            throw error;
          }
        }
      });
