import { Tool, isVercelTool, isProviderDefinedTool, validateToolInput, getNeedsApprovalFn, validateToolOutput, validateToolSuspendData } from './chunk-JQJBCTIC.js';
...
import { wrapMastra, createObservabilityContext } from './chunk-TJLLOCZN.js';
import { getOrCreateSpan, EntityType, executeWithContext } from './chunk-GXMRXZKZ.js';
import { MastraFGAPermissions } from './chunk-HIW7BSXS.js';
import { backgroundOverrideZodSchema, backgroundOverrideJsonSchema } from './chunk-RBRYISS2.js';
...
var CoreToolBuilder = class extends MastraBase {
  ...
  createExecute(tool, options, logType) {
    ...
    return async (args, execOptions) => {
      ...
      if (fgaProvider) {
        const { getAgentToolFGAResourceId, getMCPToolFGAResourceId, getStandaloneToolFGAResourceId, requireFGA } = await import('./fga-check-JWUQ2QGZ.js');
...
//# sourceMappingURL=chunk-SHH6QOJD.js.map
//# sourceMappingURL=chunk-SHH6QOJD.js.map