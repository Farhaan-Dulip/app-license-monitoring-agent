const sections = [
  ...
  "Hero section with a welcoming image and tagline",
  "Menu overview with featured dishes",
...
async function main() {
  ...
  frame.name = "Farhan's Restaurant" + ' - Generated Experience';
  ...
  title.fontSize = 72;
  title.characters = "Farhan's Restaurant";
  ...
  subtitle.characters = "Inviting and modern with a touch of warmth.";
